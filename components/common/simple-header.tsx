...
export function SimpleHeader() {
  ...
  return (
    <header className="w-full border-b bg-white dark:bg-zinc-950 p-4 flex justify-between items-center shadow-sm">
      <div className="flex items-center gap-2">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="text-xl font-black text-zinc-800 dark:text-white tracking-tighter">
            Portal Fire Control
          </span>
        </Link>
      </div>
