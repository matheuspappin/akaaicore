...
const REPORTS = [
  ...
  { icon: DollarSign, title: "Financeiro Mensal",        desc: "Resumo de recebimentos, inadimplência e projeções.", color: "text-[#e40014] bg-[#e40014] dark:bg-[#e40014]" },
  { icon: TrendingUp, title: "Captação de Alunos",       desc: "Matrículas, desistências e taxa de retenção.",       color: "text-[#e40014] bg-[#e40014] dark:bg-[#e40014]" },
  ...
  { icon: FileText,   title: "Declaração de Matrícula",  desc: "Gere declarações individuais para os responsáveis.", color: "text-[#e40014] bg-[#e40014] dark:bg-[#e40014]" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {REPORTS.map((r) => (
          <Card key={r.title} className="bg-white/5 bg-black border border-white/10 border-white/10 hover:shadow-md transition-shadow">
            <CardContent className="p-5">
              ...
              <Button
                size="sm"
                variant="outline"
                className="w-full rounded-xl font-bold text-xs border-white/10 border-white/10 hover:bg-black dark:hover:bg-white/5"
              >
