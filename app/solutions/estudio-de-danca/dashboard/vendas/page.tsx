      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="flex-1 p-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="bg-white/5 bg-black p-4 rounded-xl border shadow-sm flex gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[400px] overflow-y-auto pr-2 scrollbar-thin">
                  {pendingOS
                    ...
                    .map(os => (
                      <Card key={os.id} className="hover:border-[#e40014] cursor-pointer border-l-4 border-l-red- transition-all" onClick={() => addOSToCart(os)}>
                        <CardContent className="p-4 flex justify-between items-center">
                          ...
                          <div className="text-right ml-4">
                            <p className="text-[#e40014] font-bold">{formatPrice(os.total_amount)}</p>
