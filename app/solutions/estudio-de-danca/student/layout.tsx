  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center gap-4">
        <Loader2 className="w-10 h-10 animate-spin text-[#e40014]" />
    ...
    <div className="min-h-screen bg-black bg-black flex flex-col">
      ...
      <header className="sticky top-0 z-50 h-16 flex items-center justify-between gap-4 px-4 md:px-6 bg-black/95 border-b border-white/10 backdrop-blur-md">
        <Link href="/solutions/estudio-de-danca/student" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-xl bg-[#e40014] flex items-center justify-center shadow-lg shadow-red-600/25">
            <Music className="w-5 h-5 text-white" />
          </div>
          <div>
            <span className="font-black text-white tracking-tighter text-base block leading-tight">AKAAI Dance</span>
            <span className="text-[10px] text-[#e40014] font-bold uppercase tracking-widest">Portal do Aluno</span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#e40014] hover:bg-[#e40014] text-[#e40014] hover:text-white transition-all border border-[#e40014]"
          >
          ...
          <button
            ...
            disabled={loggingOut}
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-white/60 hover:text-[#e40014] hover:bg-[#e40014] text-xs font-bold uppercase tracking-widest transition-all disabled:opacity-50"
          >
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "text-[#e40014] border-[#e40014]"
                    : "text-zinc-500 hover:text-[#e40014] border-transparent hover:border-[#e40014]"
                )}
              >
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "text-zinc-400 hover:text-[#e40014]"
              )}
            >
