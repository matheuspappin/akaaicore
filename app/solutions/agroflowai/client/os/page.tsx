  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-zinc-400 mt-1">Serviços ambientais agendados para sua propriedade</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {filtered.map(os => {
            ...
            return (
              <Card key={os.id} className={cn("bg-zinc-950/50 border-l-4 border-zinc-800 hover:border-slate-700 transition-colors")}>
