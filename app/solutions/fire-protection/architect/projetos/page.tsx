          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            {!isPending && (
              <Link href={`${BASE_PATH}/${project.id}`}>
                <Button size="sm" variant="ghost" className="text-zinc-400 hover:text-violet-600">
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-zinc-500 mt-1 ml-10">Acompanhe o progresso de todos os seus projetos PPCI</p>
        </div>
      </div>
      ...
      <Dialog open={!!acceptTarget} onOpenChange={(open) => !open && setAcceptTarget(null)}>
        <DialogContent>
          ...
          {acceptTarget && (
            <div className="rounded-xl bg-slate-50 dark:bg-zinc-950 p-4 space-y-2 text-sm border border-violet-100 dark:border-violet-900/30">
