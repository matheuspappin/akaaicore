...
const navItems = [
  { href: "/solutions/fire-protection/technician", label: "Dashboard", icon: LayoutDashboard },
  { href: "/solutions/fire-protection/technician/os", label: "Minhas OS", icon: ClipboardList },
  { href: "/solutions/fire-protection/technician/scanner", label: "Scanner", icon: QrCode },
  { href: "/solutions/fire-protection/technician/perfil", label: "Meu Perfil", icon: UserCircle },
]
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-black border-b border-white/10 flex items-center justify-between px-4 z-40">
        <div className="flex items-center gap-2">
          ...
          <span className="font-black text-white text-sm">FireControl <span className="text-orange-400">Técnico</span></span>
        </div>
