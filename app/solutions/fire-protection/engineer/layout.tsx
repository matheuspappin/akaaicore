...
const navItems = [
  { href: "/solutions/fire-protection/engineer", label: "Dashboard", icon: LayoutDashboard },
  { href: "/solutions/fire-protection/engineer/projetos", label: "Projetos PPCI", icon: FolderKanban },
  { href: "/solutions/fire-protection/engineer/perfil", label: "Meu Perfil", icon: UserCircle },
]
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-black border-b border-white/10 flex items-center justify-between px-4 z-40">
        <div className="flex items-center gap-2">
          ...
          <span className="font-black text-white text-sm">FireControl <span className="text-red-400">Eng</span></span>
        </div>
