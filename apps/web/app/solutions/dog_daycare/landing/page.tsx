...
import { Dog,  useState, useEffect, useRef } from "react"
...
import {
  Check, ArrowRight, ArrowLeft, Dog, CreditCard, Calendar,
  DollarSign, Layout,
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {[
              ...
              { value: "+12k", label: "Tutors gerenciados" },
        ...
        <div className="grid md:grid-cols-12 gap-8 items-center max-w-6xl mx-auto">
          ...
          <div className="md:col-span-7 space-y-6">
            {[
              ...
              { id: 'qrcode', title: 'Check-in por QR Code', desc: 'Tutors fazem check-in autônomo na entrada do estúdio.', icon: Smartphone }
            ].map((feature) => (
              <div
                key={feature.id}
              ...
              <div className="w-full h-full bg-slate-50 pt-10 pb-4 px-4 flex flex-col">
                ...
                <div className="bg-orange-700 p-4 rounded-2xl shadow-xl border border-orange-600 mb-4">
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-sm text-white">AKAAI Pet — Portal</span>
...
function ManagementDashboard() {
  const stats = [
    { label: "Tutors Ativos", value: "124", icon: Users, color: "text-orange-500", trend: "+8 este mês" },
  ...
  const modules = [
    ...
    { label: "Tutors", icon: Users, color: "bg-pink-600", shadow: "shadow-pink-500/30", description: "Cadastro completo com histórico de frequência." },
    ...
    { label: "Monitores", icon: Heart, color: "bg-rose-600", shadow: "shadow-rose-500/30", description: "Agenda, pagamentos e avaliações de professores." },
...
function FeatureGrid() {
  const features = [
    ...
    { title: "Captação de Tutors", description: "Formulário de matrícula online e funil de leads integrado.", icon: UserPlus, color: "from-pink-500 to-rose-400" },
    { title: "Multi-Atividade", description: "Ballet, jazz, funk, sapateado, contemporâneo e muito mais.", icon: Dog, color: "from-amber-500 to-orange-400" },
  ]
    ...
    <section id="pricing" className="py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
        ...
        <p className="text-slate-500 max-w-2xl mx-auto text-lg mb-16">
          O AKAAI Pet é implantado com suporte especializado. Entre em contato para que nossa equipe entenda o seu estúdio e configure a plataforma perfeita para vocês.
        </p>
        ...
        <div className="bg-gradient-to-br from-orange-600 to-pink-600 rounded-3xl p-10 text-white shadow-2xl shadow-orange-500/20">
          ...
          <p className="text-orange-100 mb-8">
            Fale com nosso time e receba uma demonstração exclusiva do AKAAI Pet para o seu estúdio.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/5511999999999?text=Olá! Tenho interesse no AKAAI Pet para meu estúdio de dança."
              target="_blank"
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-slate-400 text-xl max-w-2xl mx-auto mb-12">
            Junte-se a centenas de estúdios que já modernizaram sua gestão com o AKAAI Pet.
          </p>
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12 pb-12 border-b border-white/5">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="text-slate-400 text-xs leading-relaxed">
              O ecossistema **akaaicore** fornece a infraestrutura robusta, modular e baseada em IA que alimenta o AKAAI Pet, 
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-4">
          <p className="text-slate-600 text-[10px] uppercase tracking-[0.2em] font-black">
            © {new Date().getFullYear()} AKAAI Pet — powered by akaaicore. Todos os direitos reservados.
          </p>
