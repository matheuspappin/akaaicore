...
export default function PlanosPage() {
  ...
  const verifyPayment = async (sessionId: string) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        window.location.replace("/solutions/dog_daycare/dashboard/planos")
      } else {
        toast({
          title: "Erro ao sincronizar",
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const successUrl = `${baseUrl}/solutions/dog_daycare/dashboard/planos?success=true&session_id={CHECKOUT_SESSION_ID}`
      const cancelUrl = `${baseUrl}/solutions/dog_daycare/dashboard/planos?canceled=true`
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <div className="flex items-center gap-3 mb-6 px-1">
        <Link
          href="/solutions/dog_daycare/dashboard/configuracoes"
