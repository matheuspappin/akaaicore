...
const CAL_COLORS = [
  ...
  { bg: "bg-violet-100 dark:bg-orange-900/40", text: "text-orange-800 dark:text-violet-200", border: "border-orange-300 dark:border-orange-700" },
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        // Carrega professores via API CrecheCanina (professionals com professional_type = 'teacher')
      ...
      {loading ? (
        ...
        <Card className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10">
          <CardContent className="flex flex-col items-center justify-center py-20 text-center">
            ...
            {!activeStyle && (
              <Button onClick={() => setIsNewDialogOpen(true)} className="bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-xl">
            ...
            <Card key={turma.id} className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 hover:shadow-lg transition-all overflow-hidden">
              ...
              <CardContent className="p-5">
                ...
                <div className="mt-4 flex gap-2">
                  <Link href={`/solutions/dog_daycare/dashboard/turmas/${turma.id}/chamada`}>
                    <Button size="sm" variant="outline" className="flex-1 rounded-xl text-xs font-bold border-violet-200 text-orange-600 hover:bg-violet-50">
                      Fazer Chamada
                    </Button>
                  </Link>
                  <Button
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button type="button" size="sm" variant="outline" onClick={addScheduleItem} className="h-7 text-xs font-bold rounded-lg border-violet-200 text-orange-600 hover:bg-violet-50">
                ...
                <>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button type="button" size="sm" variant="outline" onClick={addEditScheduleItem} className="h-7 text-xs font-bold rounded-lg border-violet-200 text-orange-600 hover:bg-violet-50">
