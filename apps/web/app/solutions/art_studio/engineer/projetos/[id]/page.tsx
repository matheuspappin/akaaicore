...
const PROJECTS_PATH = "/solutions/art_studio/engineer/projetos"
...
const STATUS_CONFIG: Record<string, { label: string; color: string; icon: React.ComponentType<{ className?: string }> }> = {
  ...
  in_progress:       { label: "Em Andamento",       color: "bg-red-100 text-violet-700",     icon: HardHat },
...
const STATUS_TRANSITIONS: Record<string, { label: string; next: string; color: string }[]> = {
  ...
  waiting_parts: [
    { label: "Retomar Andamento", next: "in_progress", color: "bg-red-100 text-violet-700 hover:bg-red-200" },
    { label: "Marcar como Concluído", next: "finished", color: "bg-emerald-600 text-white hover:bg-emerald-700" },
  ],
}
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="text-sm text-slate-400 flex items-center gap-1">
          <Link href={PROJECTS_PATH} className="hover:text-violet-600 transition-colors">Projetos PPCI</Link>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 rounded-2xl bg-red-50 dark:bg-violet-900/20 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <Badge className="bg-red-100 text-violet-700 font-bold">PPCI</Badge>
                </div>
                ...
                {comments.length === 0 ? (
                  ...
                  comments.map((comment: any) => (
                    <div key={comment.id} className="flex gap-3">
                      <div className="w-8 h-8 rounded-full bg-red-100 dark:bg-violet-900/30 flex items-center justify-center flex-shrink-0">
