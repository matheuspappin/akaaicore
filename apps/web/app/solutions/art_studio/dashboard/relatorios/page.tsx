...
const relatoriosDisponiveis = [
  {
    ...
    bg: "bg-violet-600/10",
    badge: "Operacional",
    badgeClass: "bg-red-100 text-violet-700",
    dados: [
...
const resumoKPIs = [
  ...
  { label: "Faturamento", valor: "R$ 19k", icone: DollarSign, color: "text-violet-600", bg: "bg-violet-600/10", tendencia: "+12% vs. mês anterior" },
]
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="h-2 rounded-full bg-slate-100 dark:bg-white/10 overflow-hidden">
        <div
          className="h-full rounded-full bg-gradient-to-r from-violet-600 to-orange-500 transition-all duration-700"
          style={{ width: `${pct}%` }}
        />
      </div>
    </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              <Button key={doc.label} variant="outline" className="h-auto p-4 flex-col items-start gap-2 hover:border-violet-300 hover:bg-red-50 dark:hover:bg-violet-600/5 transition-all">
                <doc.icone className="w-5 h-5 text-violet-600" />
