      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {/* Botão PDV */}
            <Link href={`/solutions/photographer/dashboard/vendas`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          {
            href: "/solutions/photographer/dashboard/vendas",
            icon: ShoppingCart,
          ...
          {
            href: "/solutions/photographer/dashboard/os",
            icon: ClipboardList,
          ...
          {
            href: "/solutions/photographer/dashboard/vistorias",
            icon: Calendar,
            label: "Agendar Vistoria",
            desc: "Agenda vistoria técnica",
            color: "text-zinc-600",
            bg: "bg-red-50 dark:bg-zinc-600/10 border-red-200 dark:border-zinc-600/30",
          },
        ].map((item) => (
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-xl bg-red-100 dark:bg-zinc-600/15 flex items-center justify-center text-zinc-600 font-black text-lg flex-shrink-0">
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      onClick={(e) => {
                        e.stopPropagation()
                        window.location.href = '/solutions/photographer/dashboard/vendas'
                      }}
                    ...
                    <Link
                      href="/solutions/photographer/dashboard/vistorias"
                      onClick={(e) => e.stopPropagation()}
                      className="flex-1 flex items-center justify-center gap-1 text-xs font-bold py-1.5 rounded-lg bg-red-50 dark:bg-zinc-600/10 text-zinc-700 dark:text-zinc-400 hover:bg-red-100 dark:hover:bg-zinc-600/20 transition-colors"
                    >
