      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {/* Botão PDV */}
            <Link href={`/solutions/electrician/dashboard/vendas`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          {
            href: "/solutions/electrician/dashboard/vendas",
            icon: ShoppingCart,
          ...
          {
            href: "/solutions/electrician/dashboard/os",
            icon: ClipboardList,
          ...
          {
            href: "/solutions/electrician/dashboard/vistorias",
            icon: Calendar,
            label: "Agendar Vistoria",
            desc: "Agenda vistoria técnica",
            color: "text-yellow-600",
            bg: "bg-red-50 dark:bg-yellow-600/10 border-red-200 dark:border-yellow-600/30",
          },
        ].map((item) => (
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-xl bg-red-100 dark:bg-yellow-600/15 flex items-center justify-center text-yellow-600 font-black text-lg flex-shrink-0">
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      onClick={(e) => {
                        e.stopPropagation()
                        window.location.href = '/solutions/electrician/dashboard/vendas'
                      }}
                    ...
                    <Link
                      href="/solutions/electrician/dashboard/vistorias"
                      onClick={(e) => e.stopPropagation()}
                      className="flex-1 flex items-center justify-center gap-1 text-xs font-bold py-1.5 rounded-lg bg-red-50 dark:bg-yellow-600/10 text-yellow-700 dark:text-yellow-400 hover:bg-red-100 dark:hover:bg-yellow-600/20 transition-colors"
                    >
