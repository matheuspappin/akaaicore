...
const etapas = [
  ...
  { key: "perdido", label: "Perdido", color: "bg-yellow-500", textColor: "text-yellow-700 dark:text-yellow-400", bg: "bg-red-100 dark:bg-yellow-600/20" },
]
              ...
              <CardContent className="p-5">
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className="w-10 h-10 rounded-xl bg-yellow-600/10 flex items-center justify-center flex-shrink-0">
