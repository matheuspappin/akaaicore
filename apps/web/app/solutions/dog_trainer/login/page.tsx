...
function LoginContent() {
  ...
  function redirectByRole(userRole: string) {
    ...
    else if (userRole === 'student') router.push("/solutions/dog_trainer/student")
    else if (userRole === 'teacher') router.push("/solutions/dog_trainer/teacher")
    else if (userRole === 'finance') router.push("/solutions/dog_trainer/dashboard/financeiro")
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex relative font-sans">
      <button
        type="button"
        onClick={() => router.push("/solutions/dog_trainer")}
      ...
      {/* Left Side — Adestramento Branding */}
            ...
            <CardContent className="px-6 pb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/forgot-password?returnTo=/solutions/dog_trainer/login" className="text-xs text-orange-500/80 hover:text-orange-400 transition-colors">
                      Esqueceu?
                    </Link>
                  </div>
                  <div className="relative">
              ...
              <div className="mt-6 pt-5 border-t border-white/5 space-y-4">
                <p className="text-center text-sm text-slate-500">
                  Não possui conta?{" "}
                  <Link href="/solutions/dog_trainer/register" className="text-orange-500 hover:text-orange-400 font-medium transition-colors">
                    Criar conta grátis
                  </Link>
                </p>
                <Link
