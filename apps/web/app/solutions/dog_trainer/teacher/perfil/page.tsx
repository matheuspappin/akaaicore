        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1 flex-wrap">
            ...
            {vinculo.linked && vinculo.studio && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-violet-100 dark:bg-orange-600/20 text-orange-700 dark:text-orange-400 text-[10px] font-black uppercase tracking-widest">
