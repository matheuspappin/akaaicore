...
const navItems = [
  { href: "/solutions/dog_trainer/teacher",         label: "Dashboard",   icon: LayoutDashboard },
  { href: "/solutions/dog_trainer/teacher/turmas",  label: "Minhas Turmas", icon: Calendar },
  { href: "/solutions/dog_trainer/teacher/chamada", label: "Chamada",     icon: ClipboardList },
  { href: "/solutions/dog_trainer/teacher/pagamentos", label: "Meus Pagamentos", icon: DollarSign },
  { href: "/solutions/dog_trainer/teacher/perfil",  label: "Meu Perfil",  icon: UserCircle },
]
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between p-4 border-b border-white/10">
        <Link href="/solutions/dog_trainer" className="flex items-center gap-2">
          ...
          {(!collapsed || isMobile) && (
            <div>
              <span className="font-black text-white tracking-tighter text-xs block">Adestramento</span>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-slate-950 border-b border-white/10 flex items-center justify-between px-4 z-40">
        <div className="flex items-center gap-2">
          ...
          <span className="font-black text-white text-sm">
            Adestramento <span className="text-pink-400">Professor</span>
          </span>
        </div>
