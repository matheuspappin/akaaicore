...
const relatoriosDisponiveis = [
  {
    ...
    bg: "bg-blue-600/10",
    badge: "Operacional",
    badgeClass: "bg-red-100 text-blue-700",
    dados: [
...
const resumoKPIs = [
  ...
  { label: "Faturamento", valor: "R$ 19k", icone: DollarSign, color: "text-blue-600", bg: "bg-blue-600/10", tendencia: "+12% vs. mês anterior" },
]
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              <Button key={doc.label} variant="outline" className="h-auto p-4 flex-col items-start gap-2 hover:border-blue-300 hover:bg-red-50 dark:hover:bg-blue-600/5 transition-all">
                <doc.icone className="w-5 h-5 text-blue-600" />
