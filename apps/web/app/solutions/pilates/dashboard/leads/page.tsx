...
const stageMap: Record<string, { label: string; color: string }> = {
  ...
  contacted:       { label: "Contactado",  color: "bg-violet-100 text-teal-700 dark:bg-teal-600/20 dark:text-teal-400" },
...
export default function LeadsPage() {
  ...
  const handleConvidarLead = (lead: any) => {
    ...
    const link = `${origin}/solutions/pilates/register?role=student&code=${inviteCode}`
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        copiedLinkId === lead.id
                          ...
                          : "text-teal-600 border-violet-200 hover:bg-violet-50 dark:border-teal-600/30 dark:text-teal-400 dark:hover:bg-teal-600/10"
                      )}
                    >
                      {copiedLinkId === lead.id
