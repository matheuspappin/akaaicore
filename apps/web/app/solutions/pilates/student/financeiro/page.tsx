...
const usageConfig: Record<UsageEntry['usage_type'], { label: string; icon: any; color: string; sign: string }> = {
  class_attendance: { label: 'Aula realizada',    icon: Zap,         color: 'bg-violet-100 text-teal-600 dark:bg-teal-600/20', sign: '-' },
    ...
    try {
      const res = await fetch('/api/dance-studio/packages/checkout', {
        ...
        body: JSON.stringify({
          ...
          successUrl: `${window.location.origin}/solutions/pilates/student/financeiro?payment=success&session_id={CHECKOUT_SESSION_ID}`,
          cancelUrl: `${window.location.origin}/solutions/pilates/student/financeiro?payment=cancelled`,
        }),
      })
            ...
            <div className={cn(
              ...
              expired
                ...
                : credits.remaining_credits <= 2
                  ...
                  : 'bg-gradient-to-br from-teal-600 via-indigo-600 to-purple-700'
            )}>
              {/* Decoração de fundo */}
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isPopular
                      ? 'border-teal-500 bg-violet-50 dark:bg-violet-950/20 shadow-md shadow-teal-500/10'
                      : 'border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/50 hover:border-teal-300 dark:hover:border-teal-700/50'
                  )}
                >
                  {isPopular && (
                    <div className="absolute top-0 right-0 bg-teal-600 text-white text-[10px] font-black px-3 py-1 rounded-bl-xl">
                      MAIS POPULAR
                    </div>
                  )}
                  ...
                  <div className="p-4 flex items-center gap-4">
                    ...
                    <div className={cn(
                      ...
                      isPopular
                        ...
                        : 'bg-violet-100 dark:bg-teal-600/20 text-teal-700 dark:text-teal-400'
                    )}>
                    ...
                    <div className="text-right shrink-0 flex flex-col items-end gap-2">
                      ...
                      <Button
                        ...
                        className={cn(
                          ...
                          isPopular
                            ? 'bg-teal-600 hover:bg-teal-700 text-white shadow-sm shadow-teal-600/25'
            ...
            <CardContent className="p-0">
              ...
              {usage.length > 5 && (
                <button
                  ...
                  className="w-full py-3 text-xs font-bold text-teal-600 hover:text-teal-700 hover:bg-violet-50 dark:hover:bg-violet-950/20 transition-colors flex items-center justify-center gap-1.5 border-t border-slate-100 dark:border-white/5"
                >
                  {showAllUsage ? (
