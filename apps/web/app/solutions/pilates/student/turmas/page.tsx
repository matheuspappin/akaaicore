    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <Card className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 overflow-hidden">
          <div className="h-1.5 bg-gradient-to-r from-teal-500 to-pink-500" />
          <CardContent className="flex flex-col items-center justify-center py-20 text-center px-6">
            <div className="w-20 h-20 rounded-2xl bg-violet-100 dark:bg-teal-900/30 flex items-center justify-center mb-4">
              <Music className="w-10 h-10 text-teal-600 dark:text-teal-400" />
            </div>
            ...
            <Link href="/solutions/pilates/student/turmas/catalogo">
              <Button className="bg-teal-600 hover:bg-teal-700 text-white font-bold rounded-xl gap-2">
        ...
        <>
                ...
                <CardContent className="p-5">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      {turma.dance_style && (
                        <p className="text-xs text-teal-600 dark:text-teal-400 font-bold mt-0.5">{turma.dance_style}</p>
                      )}
                    </div>
                    {turma.level && (
                      <Badge className="bg-violet-100 text-teal-700 dark:bg-teal-600/20 dark:text-teal-400 border-0 text-xs font-bold">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full mt-4 h-10 rounded-xl font-bold text-sm border-violet-200 dark:border-teal-700/50 text-teal-600 dark:text-teal-400 hover:bg-violet-50 dark:hover:bg-violet-950/30"
          ...
          <Link href="/solutions/pilates/student/turmas/catalogo">
            <Button
              variant="outline"
              className="w-full border-dashed border-2 border-violet-200 dark:border-teal-700/40 text-teal-600 dark:text-teal-400 bg-violet-50/50 dark:bg-violet-950/20 hover:bg-violet-50 dark:hover:bg-violet-950/40 h-12 rounded-xl font-bold gap-2 transition-all"
            >
      ...
      <Dialog open={isQrOpen} onOpenChange={setIsQrOpen}>
        <DialogContent className="sm:max-w-md max-w-[90vw] rounded-2xl border-none">
          ...
          <div className="flex flex-col items-center justify-center py-6 gap-6">
            <div ref={qrContainerRef} className="bg-white p-4 rounded-3xl shadow-xl border-4 border-violet-50 dark:border-teal-900/30">
              {activeAttendanceId ? (
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900 px-4 py-2 rounded-lg border border-slate-100 dark:border-slate-800 w-full text-center">
                    ...
                    <p className="font-mono text-lg font-black text-teal-600 tracking-widest">
