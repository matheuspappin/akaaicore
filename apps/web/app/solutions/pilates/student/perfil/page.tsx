  ...
  return (
    <div className="space-y-6 max-w-xl pb-20 md:pb-0">
      ...
      <div className="flex items-center gap-4">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-teal-500 to-purple-600 flex items-center justify-center text-white text-3xl font-black shadow-lg shadow-teal-600/20">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1 flex-wrap">
            <span className="inline-block px-2 py-0.5 rounded-full bg-violet-100 dark:bg-teal-600/20 text-teal-700 dark:text-teal-400 text-[10px] font-black uppercase tracking-widest">
              Aluno
            </span>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1.5">
                  O código é fornecido pelo administrador do estúdio no painel Pilates.
                </p>
              </div>
              <Button
                className="w-full bg-teal-600 hover:bg-teal-700 text-white font-bold rounded-xl"
                onClick={handleVincular}
                disabled={vinculando || !inviteCode.trim()}
              >
                {vinculando ? (
      ...
      <Card className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10">
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            onClick={handleSave}
            disabled={saving}
            className="bg-teal-600 hover:bg-teal-700 text-white font-bold rounded-xl w-full h-11"
          >
      ...
      <div className="space-y-3">
        ...
        <Link href="/solutions/pilates/student/perfil/privacidade">
        ...
        <Link href="/solutions/pilates/student/perfil/preferencias">
          <Button variant="ghost" className="w-full justify-between bg-white dark:bg-slate-900/50 h-14 px-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 border border-slate-200 dark:border-white/10 rounded-xl">
            <div className="flex items-center gap-3">
        ...
        <Button
          ...
          onClick={async () => {
            ...
            window.location.href = "/solutions/pilates/login"
          }}
        >
          <div className="flex items-center gap-3">
