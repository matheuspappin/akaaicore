...
import {
  Check, ArrowRight, ArrowLeft, Activity, CreditCard, Calendar,
  DollarSign, Layout,
      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 font-bold text-2xl tracking-tight text-white hover:opacity-80 transition-opacity">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">
            Pilates <span className="text-teal-400 font-black"></span>
          </span>
        </Link>
                ...
                {activeTab === 'chamada' && (
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col h-full">
                    <div className="bg-white p-4 rounded-2xl shadow-sm mb-4 flex items-center justify-between">
                      ...
                      <Badge className="bg-teal-100 text-teal-600 border-none">Turma Ballet</Badge>
                    </div>
              ...
              <div className="w-full h-full bg-slate-50 pt-10 pb-4 px-4 flex flex-col">
                ...
                <div className="bg-teal-700 p-4 rounded-2xl shadow-xl border border-teal-600 mb-4">
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-sm text-white">AKAAI Zen — Portal</span>
...
function FeatureGrid() {
  const features = [
    ...
    { title: "Multi-Nível", description: "Ballet, jazz, funk, sapateado, contemporâneo e muito mais.", icon: Activity, color: "from-amber-500 to-orange-400" },
  ]
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Badge className="bg-teal-100 text-teal-600 border-none px-4 py-1.5 mb-6 uppercase tracking-[0.2em] text-[10px] font-black shadow-sm">
              Recursos
            </Badge>
  ...
  return (
    <section id="pricing" className="py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
        <Badge className="bg-teal-100 text-teal-600 border-none px-4 py-1.5 mb-6 uppercase tracking-[0.2em] text-[10px] font-black">
          Implementação
        </Badge>
        <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">
        ...
        <p className="text-slate-500 max-w-2xl mx-auto text-lg mb-16">
          O AKAAI Zen é implantado com suporte especializado. Entre em contato para que nossa equipe entenda o seu estúdio e configure a plataforma perfeita para vocês.
        </p>
        ...
        <div className="bg-gradient-to-br from-teal-600 to-pink-600 rounded-3xl p-10 text-white shadow-2xl shadow-teal-500/20">
          ...
          <p className="text-teal-100 mb-8">
            Fale com nosso time e receba uma demonstração exclusiva do AKAAI Zen para o seu estúdio.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/5511999999999?text=Olá! Tenho interesse no AKAAI Zen para meu estúdio de dança."
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-white text-teal-700 hover:bg-teal-50 font-bold h-14 px-8 rounded-2xl transition-all shadow-lg"
            >
              <Activity className="w-5 h-5" />
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-pink-400">seu estúdio?</span>
          </h2>
          <p className="text-slate-400 text-xl max-w-2xl mx-auto mb-12">
            Junte-se a centenas de estúdios que já modernizaram sua gestão com o AKAAI Zen.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12 pb-12 border-b border-white/5">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="text-slate-400 text-xs leading-relaxed">
              O ecossistema **akaaicore** fornece a infraestrutura robusta, modular e baseada em IA que alimenta o AKAAI Zen, 
