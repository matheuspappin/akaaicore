...
export default function EngineerPerfilPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Avatar + Info */}
      <Card className="bg-gradient-to-br from-orange-700 via-orange-600 to-orange-600 border-none text-white">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { label: "Em Andamento", value: stats.active, color: "text-orange-600", bg: "bg-red-50 dark:bg-orange-900/10", icon: Flame },
        ...
        <CardContent className="space-y-6">
            ...
            {loadingCompanies ? (
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {companies.map((company) => (
                  <div
                    key={company.id}
                    className="flex flex-col p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl hover:border-orange-500/50 transition-colors"
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="w-9 h-9 bg-red-100 dark:bg-orange-900/20 rounded-lg flex items-center justify-center text-orange-600">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-red-50 dark:bg-orange-900/20 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <Button
                ...
                className="h-10 font-bold bg-orange-600 hover:bg-orange-700 text-white min-w-[120px]"
              >
                {isValidating ? (
