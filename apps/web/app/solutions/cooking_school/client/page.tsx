    ...
    <div className="space-y-8 pb-20 md:pb-0">
      ...
      <Card className="bg-white dark:bg-slate-900/50 shadow-sm border border-slate-200 dark:border-white/10">
        <CardHeader className="flex flex-row items-center justify-between pb-3">
          ...
          <Link href="/solutions/cooking_school/client/extintores">
      ...
      <Card className="bg-white dark:bg-slate-900/50 shadow-sm border border-slate-200 dark:border-white/10">
        <CardHeader className="flex flex-row items-center justify-between pb-3">
          ...
          <Link href="/solutions/cooking_school/client/documentos">
      ...
      <Card
        className="bg-gradient-to-r from-orange-600 to-orange-700 text-white border-none shadow-xl cursor-pointer transition-opacity hover:opacity-95"
