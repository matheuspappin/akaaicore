...
import { FireControlLogoCanvas as VeterináriaLogoCanvas } from "@/components/fire-protection/fire-control-logo-canvas"

import { OFFICIAL_LOGO } from "@/config/branding"

export default function VeterináriaPrePage() {
  useEffect(() => {
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6">
        ...
        >
          <div className="flex flex-col items-center gap-4 mb-6">
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="h-14 md:h-16 min-w-[280px] md:min-w-[360px] w-full max-w-[360px] flex items-center justify-center overflow-visible" aria-label="Veterinária">
                <VeterináriaLogoCanvas className="w-full h-full" text="Veterinária" />
              </div>
            </div>
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-md mx-auto font-medium">
            Gestão inteligente para Veterinária
          </p>
        </motion.div>
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href="/solutions/vet/landing">
