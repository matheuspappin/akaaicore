        ...
        <div className="flex-1 flex flex-col bg-white dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-white/10 overflow-hidden shadow-sm min-w-0">
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {messages.map((msg) => (
              ...
              >
                {msg.role === "assistant" && (
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-emerald-600 flex items-center justify-center text-white flex-shrink-0 mr-2 mt-1">
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-emerald-600 flex items-center justify-center text-white flex-shrink-0 mr-2">
                  <Sparkles className="w-4 h-4" />
                </div>
            ...
            <div className="px-4 pb-3 flex flex-wrap gap-2">
              {sugestoes.map((s) => (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-white/5 hover:bg-red-50 dark:hover:bg-emerald-600/10 hover:text-emerald-600 text-xs font-bold text-slate-600 dark:text-slate-300 transition-all border border-slate-200 dark:border-white/10"
                >
