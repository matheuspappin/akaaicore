  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        setSuccess(true)
        setTimeout(() => {
          router.push("/solutions/clinic_vet/dashboard/os")
        }, 1500)
      }
    } finally {
      setLoading(false)
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div>
            ...
            {loadingData ? (
              ...
              <div className="mt-1.5 p-3 rounded-xl border border-dashed border-slate-300 dark:border-white/10 text-sm text-slate-400 text-center">
                ...
                <Link href="/solutions/clinic_vet/dashboard/clientes" className="text-emerald-600 hover:underline font-bold">
                  Cadastrar cliente
                </Link>
              </div>
            ) : (
      ...
      <div className="flex gap-3 pb-8">
        <Link href="/solutions/clinic_vet/dashboard/os" className="flex-1">
