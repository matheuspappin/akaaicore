...
const stageMap: Record<string, { label: string; color: string }> = {
  ...
  contacted:       { label: "Contactado",  color: "bg-violet-100 text-orange-700 dark:bg-orange-600/20 dark:text-orange-400" },
...
export default function LeadsPage() {
  ...
  const handleConvidarLead = (lead: any) => {
    ...
    const link = `${origin}/solutions/beach_tennis/register?role=student&code=${inviteCode}`
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        copiedLinkId === lead.id
                          ...
                          : "text-orange-600 border-violet-200 hover:bg-violet-50 dark:border-orange-600/30 dark:text-orange-400 dark:hover:bg-orange-600/10"
                      )}
                    >
                      {copiedLinkId === lead.id
