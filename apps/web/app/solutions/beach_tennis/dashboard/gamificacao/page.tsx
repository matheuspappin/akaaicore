  ...
  return (
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link href="/solutions/beach_tennis/dashboard/configuracoes?tab=gamificacao">
              ...
              ranking.map((item) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="w-9 h-9 rounded-full bg-orange-600/10 flex items-center justify-center font-black text-orange-600 text-sm">
            ...
            {achievements.length === 0 ? (
              ...
              achievements.map((ach, i) => {
                ...
                const colors = [
                  ...
                  "text-orange-500 bg-violet-100 dark:bg-orange-600/20",
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: "Alunos Ativos", value: String(stats.studentsActive), icon: Users, color: "text-orange-600 bg-violet-100 dark:bg-orange-600/20" },
