...
const usageConfig: Record<UsageEntry['usage_type'], { label: string; icon: any; color: string; sign: string }> = {
  class_attendance: { label: 'Aula realizada',    icon: Zap,         color: 'bg-violet-100 text-orange-600 dark:bg-orange-600/20', sign: '-' },
    ...
    try {
      const res = await fetch('/api/dance-studio/packages/checkout', {
        ...
        body: JSON.stringify({
          ...
          successUrl: `${window.location.origin}/solutions/beach_tennis/student/financeiro?payment=success&session_id={CHECKOUT_SESSION_ID}`,
          cancelUrl: `${window.location.origin}/solutions/beach_tennis/student/financeiro?payment=cancelled`,
        }),
      })
            ...
            <div className={cn(
              ...
              expired
                ...
                : credits.remaining_credits <= 2
                  ...
                  : 'bg-gradient-to-br from-orange-600 via-indigo-600 to-purple-700'
            )}>
              {/* Decoração de fundo */}
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isPopular
                      ? 'border-orange-500 bg-violet-50 dark:bg-violet-950/20 shadow-md shadow-orange-500/10'
                      : 'border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/50 hover:border-orange-300 dark:hover:border-orange-700/50'
                  )}
                >
                  {isPopular && (
                    <div className="absolute top-0 right-0 bg-orange-600 text-white text-[10px] font-black px-3 py-1 rounded-bl-xl">
                      MAIS POPULAR
                    </div>
                  )}
                  ...
                  <div className="p-4 flex items-center gap-4">
                    ...
                    <div className={cn(
                      ...
                      isPopular
                        ...
                        : 'bg-violet-100 dark:bg-orange-600/20 text-orange-700 dark:text-orange-400'
                    )}>
                    ...
                    <div className="text-right shrink-0 flex flex-col items-end gap-2">
                      ...
                      <Button
                        ...
                        className={cn(
                          ...
                          isPopular
                            ? 'bg-orange-600 hover:bg-orange-700 text-white shadow-sm shadow-orange-600/25'
            ...
            <CardContent className="p-0">
              ...
              {usage.length > 5 && (
                <button
                  ...
                  className="w-full py-3 text-xs font-bold text-orange-600 hover:text-orange-700 hover:bg-violet-50 dark:hover:bg-violet-950/20 transition-colors flex items-center justify-center gap-1.5 border-t border-slate-100 dark:border-white/5"
                >
                  {showAllUsage ? (
