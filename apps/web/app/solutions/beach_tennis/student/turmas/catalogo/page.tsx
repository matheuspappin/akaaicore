      ...
      {!loading && studentCredits && (
        <div className={cn(
          ...
          creditsExpired
            ...
            : hasCredits
              ? "bg-violet-50 dark:bg-violet-950/30 border-violet-200 dark:border-orange-800"
          ...
          {(!hasCredits || creditsExpired) && (
            <Link href="/solutions/beach_tennis/student/financeiro">
              <Button size="sm" className="bg-orange-600 hover:bg-orange-700 text-white text-xs font-bold h-8 px-3 rounded-xl">
                Comprar
              </Button>
            </Link>
          )}
              ...
              <Card
                ...
                className={cn(
                  ...
                  isEnrolled
                    ...
                    : "border-slate-200 dark:border-white/10 hover:border-orange-300 dark:hover:border-orange-700/50"
                )}
              >
                  ...
                  {isEnrolled ? (
                    <div className="flex flex-col gap-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="w-full h-9 rounded-xl font-bold text-sm border-violet-200 dark:border-orange-700/50 text-orange-600 dark:text-orange-400 hover:bg-violet-50 dark:hover:bg-violet-950/30"
