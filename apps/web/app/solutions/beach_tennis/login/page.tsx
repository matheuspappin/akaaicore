...
function LoginContent() {
  ...
  function redirectByRole(userRole: string) {
    ...
    else if (userRole === 'student') router.push("/solutions/beach_tennis/student")
    else if (userRole === 'teacher') router.push("/solutions/beach_tennis/teacher")
    else if (userRole === 'finance') router.push("/solutions/beach_tennis/dashboard/financeiro")
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex relative font-sans">
      <button
        type="button"
        onClick={() => router.push("/solutions/beach_tennis")}
      ...
      {/* Left Side — BeachTennis Branding */}
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-slate-950 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-md">
          <div className="lg:hidden mb-12 text-center">
            <Link href="/solutions/beach_tennis" className="inline-flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-orange-600 flex items-center justify-center shadow-lg shadow-orange-600/20">
                <Music className="w-6 h-6 text-white" />
              </div>
              <span className="text-2xl font-black text-white tracking-tighter">
                AKAAI <span className="text-orange-500">Court</span>
              </span>
            </Link>
          </div>
            ...
            <CardContent className="px-6 pb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/forgot-password?returnTo=/solutions/beach_tennis/login" className="text-xs text-orange-500/80 hover:text-orange-400 transition-colors">
                      Esqueceu?
                    </Link>
                  </div>
                  <div className="relative">
              ...
              <div className="mt-6 pt-5 border-t border-white/5 space-y-4">
                <p className="text-center text-sm text-slate-500">
                  Não possui conta?{" "}
                  <Link href="/solutions/beach_tennis/register" className="text-orange-500 hover:text-orange-400 font-medium transition-colors">
                    Criar conta grátis
                  </Link>
                </p>
                <Link
