...
export default function ComplianceAmbientaleEngenhariaPrePage() {
  useEffect(() => {
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6">
        ...
        >
          <div className="flex flex-col items-center gap-4 mb-6">
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="h-14 md:h-16 min-w-[280px] md:min-w-[360px] w-full max-w-[360px] flex items-center justify-center overflow-visible" aria-label="ComplianceAmbientaleEngenharia">
            ...
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-300 text-xs font-bold uppercase tracking-widest backdrop-blur-sm">
              Compliance Ambiental e Engenharia
            </span>
          </div>
          <p className="text-slate-300 text-lg md:text-xl max-w-md mx-auto font-medium">
            Gestão inteligente para Compliance Ambiental e Engenharia
          </p>
        </motion.div>
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href="/solutions/environmental_compliance/landing">
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href="/solutions/environmental_compliance/login">
              Já tenho conta
            </Link>
          </Button>
        </motion.div>
