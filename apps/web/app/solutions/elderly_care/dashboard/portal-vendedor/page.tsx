      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {/* Botão PDV */}
            <Link href={`/solutions/elderly_care/dashboard/vendas`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          {
            href: "/solutions/elderly_care/dashboard/vendas",
            icon: ShoppingCart,
          ...
          {
            href: "/solutions/elderly_care/dashboard/os",
            icon: ClipboardList,
          ...
          {
            href: "/solutions/elderly_care/dashboard/vistorias",
            icon: Calendar,
            label: "Agendar Vistoria",
            desc: "Agenda vistoria técnica",
            color: "text-teal-600",
            bg: "bg-red-50 dark:bg-teal-600/10 border-red-200 dark:border-teal-600/30",
          },
        ].map((item) => (
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-xl bg-red-100 dark:bg-teal-600/15 flex items-center justify-center text-teal-600 font-black text-lg flex-shrink-0">
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      onClick={(e) => {
                        e.stopPropagation()
                        window.location.href = '/solutions/elderly_care/dashboard/vendas'
                      }}
                    ...
                    <Link
                      href="/solutions/elderly_care/dashboard/vistorias"
                      onClick={(e) => e.stopPropagation()}
                      className="flex-1 flex items-center justify-center gap-1 text-xs font-bold py-1.5 rounded-lg bg-red-50 dark:bg-teal-600/10 text-teal-700 dark:text-teal-400 hover:bg-red-100 dark:hover:bg-teal-600/20 transition-colors"
                    >
