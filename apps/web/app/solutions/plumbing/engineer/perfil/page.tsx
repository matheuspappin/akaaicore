...
export default function EngineerPerfilPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Avatar + Info */}
      <Card className="bg-gradient-to-br from-cyan-700 via-cyan-600 to-orange-600 border-none text-white">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { label: "Em Andamento", value: stats.active, color: "text-cyan-600", bg: "bg-red-50 dark:bg-cyan-900/10", icon: Flame },
        ...
        <CardContent className="space-y-6">
            ...
            {loadingCompanies ? (
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {companies.map((company) => (
                  <div
                    key={company.id}
                    className="flex flex-col p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl hover:border-cyan-500/50 transition-colors"
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="w-9 h-9 bg-red-100 dark:bg-cyan-900/20 rounded-lg flex items-center justify-center text-cyan-600">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-red-50 dark:bg-cyan-900/20 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <Button
                ...
                className="h-10 font-bold bg-cyan-600 hover:bg-cyan-700 text-white min-w-[120px]"
              >
                {isValidating ? (
      ...
      <Card className="bg-white dark:bg-slate-900/50 shadow-sm">
        ...
        <CardContent>
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-cyan-600 hover:bg-cyan-700 text-white font-bold rounded-xl"
              disabled={saving}
            >
              {saving ? (
