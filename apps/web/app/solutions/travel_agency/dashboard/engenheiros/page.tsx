...
const STATUS_MAP: Record<string, { label: string; className: string }> = {
  ...
  in_progress:       { label: "Em Andamento", className: "bg-red-100 text-slate-700 dark:bg-slate-600/20 dark:text-slate-400" },
                ...
                <CardContent className="p-5">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-slate-500 to-slate-700 flex items-center justify-center text-white font-black text-lg flex-shrink-0">
                  ...
                  <div className="mt-4 pt-4 border-t border-slate-100 dark:border-white/5">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-black text-slate-600">{stats.progress}%</span>
                    </div>
