              ...
              <CardContent className="p-5">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-slate-600/10 flex items-center justify-center flex-shrink-0">
                      <Building2 className="w-6 h-6 text-slate-600" />
                    </div>
                    <div>
                ...
                <div className="mt-4 pt-4 border-t border-slate-100 dark:border-white/5 grid grid-cols-3 gap-2 text-center">
                  ...
                  <div>
                    ...
                    <p className={cn("text-base font-black", cliente.osAbertas > 0 ? "text-slate-600" : "text-slate-900 dark:text-white")}>
                      {cliente.osAbertas}
                    </p>
