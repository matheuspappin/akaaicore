...
import { Languages,  useState, useEffect, useRef } from "react"
...
import {
  Check, ArrowRight, ArrowLeft, Languages, CreditCard, Calendar,
  DollarSign, Layout,
      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 font-bold text-2xl tracking-tight text-white hover:opacity-80 transition-opacity">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">
            AKAAI <span className="text-blue-400 font-black">Lingo</span>
          </span>
        </Link>
                ...
                {activeTab === 'chamada' && (
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col h-full">
                    <div className="bg-white p-4 rounded-2xl shadow-sm mb-4 flex items-center justify-between">
                      ...
                      <Badge className="bg-blue-100 text-blue-600 border-none">Turma Ballet</Badge>
                    </div>
              ...
              <div className="w-full h-full bg-slate-50 pt-10 pb-4 px-4 flex flex-col">
                ...
                <div className="bg-blue-700 p-4 rounded-2xl shadow-xl border border-blue-600 mb-4">
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-sm text-white">AKAAI Lingo — Portal</span>
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-2xl overflow-hidden p-8">
            ...
            <div className="absolute bottom-0 right-0 p-8 opacity-5 pointer-events-none">
              <Languages className="w-64 h-64 rotate-12" />
            </div>
          </div>
        </div>
      </div>
...
function FeatureGrid() {
  const features = [
    ...
    { title: "Multi-Idioma", description: "Ballet, jazz, funk, sapateado, contemporâneo e muito mais.", icon: Languages, color: "from-amber-500 to-orange-400" },
  ]
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Badge className="bg-blue-100 text-blue-600 border-none px-4 py-1.5 mb-6 uppercase tracking-[0.2em] text-[10px] font-black shadow-sm">
              Recursos
            </Badge>
  ...
  return (
    <section id="pricing" className="py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
        <Badge className="bg-blue-100 text-blue-600 border-none px-4 py-1.5 mb-6 uppercase tracking-[0.2em] text-[10px] font-black">
          Implementação
        </Badge>
        <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">
        ...
        <p className="text-slate-500 max-w-2xl mx-auto text-lg mb-16">
          O AKAAI Lingo é implantado com suporte especializado. Entre em contato para que nossa equipe entenda o seu estúdio e configure a plataforma perfeita para vocês.
        </p>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-pink-600 rounded-3xl p-10 text-white shadow-2xl shadow-blue-500/20">
          ...
          <p className="text-blue-100 mb-8">
            Fale com nosso time e receba uma demonstração exclusiva do AKAAI Lingo para o seu estúdio.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/5511999999999?text=Olá! Tenho interesse no AKAAI Lingo para meu estúdio de dança."
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-white text-blue-700 hover:bg-blue-50 font-bold h-14 px-8 rounded-2xl transition-all shadow-lg"
            >
              <Languages className="w-5 h-5" />
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-pink-400">seu estúdio?</span>
          </h2>
          <p className="text-slate-400 text-xl max-w-2xl mx-auto mb-12">
            Junte-se a centenas de estúdios que já modernizaram sua gestão com o AKAAI Lingo.
          </p>
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12 pb-12 border-b border-white/5">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="text-slate-400 text-xs leading-relaxed">
              O ecossistema **akaaicore** fornece a infraestrutura robusta, modular e baseada em IA que alimenta o AKAAI Lingo, 
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href="/solutions/language_school/login" className="text-slate-500 hover:text-blue-400 text-sm transition-colors flex items-center gap-2 group">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-4">
          <p className="text-slate-600 text-[10px] uppercase tracking-[0.2em] font-black">
            © {new Date().getFullYear()} AKAAI Lingo — powered by akaaicore. Todos os direitos reservados.
          </p>
