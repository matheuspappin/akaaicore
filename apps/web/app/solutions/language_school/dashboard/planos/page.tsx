...
export default function PlanosPage() {
  ...
  const verifyPayment = async (sessionId: string) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        window.location.replace("/solutions/language_school/dashboard/planos")
      } else {
        toast({
          title: "Erro ao sincronizar",
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const successUrl = `${baseUrl}/solutions/language_school/dashboard/planos?success=true&session_id={CHECKOUT_SESSION_ID}`
      const cancelUrl = `${baseUrl}/solutions/language_school/dashboard/planos?canceled=true`
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <div className="flex items-center gap-3 mb-6 px-1">
        <Link
          href="/solutions/language_school/dashboard/configuracoes"
                ...
                <Card
                  ...
                  className={cn(
                    ...
                    (selectedNewPlan === plan.id || selectedNewPlan === plan.plan_id)
                      ? "border-indigo-600 bg-violet-50 dark:bg-indigo-900/10 ring-2 ring-indigo-600/20"
                  ...
                  <CardContent className="p-4 flex flex-col h-full">
                    ...
                    {(usage.plan === plan.plan_id || usage.plan === plan.id) ? (
                      ...
                      <Button
                        ...
                        className="mt-4 w-full text-xs h-8 bg-indigo-600 hover:bg-indigo-700"
                      >
