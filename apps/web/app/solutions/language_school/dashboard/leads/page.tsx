...
const stageMap: Record<string, { label: string; color: string }> = {
  ...
  contacted:       { label: "Contactado",  color: "bg-violet-100 text-indigo-700 dark:bg-indigo-600/20 dark:text-indigo-400" },
...
export default function LeadsPage() {
  ...
  const handleConvidarLead = (lead: any) => {
    ...
    const link = `${origin}/solutions/language_school/register?role=student&code=${inviteCode}`
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        copiedLinkId === lead.id
                          ...
                          : "text-indigo-600 border-violet-200 hover:bg-violet-50 dark:border-indigo-600/30 dark:text-indigo-400 dark:hover:bg-indigo-600/10"
                      )}
                    >
                      {copiedLinkId === lead.id
