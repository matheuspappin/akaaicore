  ...
  return (
    <header className={cn(
      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link href="/solutions/auto_detail/landing" className="flex items-center gap-2.5 font-bold text-2xl tracking-tight text-white hover:opacity-90 transition-opacity">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Link href="/solutions/auto_detail/login" className="hidden sm:block">
          ...
          <Link href="/solutions/auto_detail/register">
          ...
          >
            <div className="flex flex-col p-6 space-y-4 font-semibold text-white">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <Link href="/solutions/auto_detail/login" onClick={() => setMobileMenuOpen(false)}>
                ...
                <Link href="/solutions/auto_detail/register" onClick={() => setMobileMenuOpen(false)}>
