...
const navItems = [
  { href: "/solutions/auto_detail/engineer", label: "Dashboard", icon: LayoutDashboard },
  { href: "/solutions/auto_detail/engineer/projetos", label: "Projetos PPCI", icon: FolderKanban },
  { href: "/solutions/auto_detail/engineer/perfil", label: "Meu Perfil", icon: UserCircle },
]
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-slate-950 border-b border-white/10 flex items-center justify-between px-4 z-40">
        <div className="flex items-center gap-2">
          ...
          <span className="font-black text-white text-sm">EstéticaAutomotiva <span className="text-slate-400">Eng</span></span>
        </div>
