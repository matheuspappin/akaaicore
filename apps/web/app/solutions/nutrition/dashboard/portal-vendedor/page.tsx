      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {/* Botão PDV */}
            <Link href={`/solutions/nutrition/dashboard/vendas`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          {
            href: "/solutions/nutrition/dashboard/vendas",
            icon: ShoppingCart,
          ...
          {
            href: "/solutions/nutrition/dashboard/os",
            icon: ClipboardList,
          ...
          {
            href: "/solutions/nutrition/dashboard/vistorias",
            icon: Calendar,
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      onClick={(e) => {
                        e.stopPropagation()
                        window.location.href = '/solutions/nutrition/dashboard/vendas'
                      }}
