...
const prioridadeConfig = [
  {
    ...
    color: "border-rose-500 bg-red-50 dark:bg-rose-600/10 text-rose-700 dark:text-rose-400",
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        setSuccess(true)
        setTimeout(() => {
          router.push("/solutions/wine_club/dashboard/os")
        }, 1500)
      }
    } finally {
      setLoading(false)
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex gap-3 pb-8">
        <Link href="/solutions/wine_club/dashboard/os" className="flex-1">
