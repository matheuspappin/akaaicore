...
const PROJECTS_PATH = "/solutions/wine_club/engineer/projetos"
...
const STATUS_CONFIG: Record<string, { label: string; color: string; icon: React.ComponentType<{ className?: string }> }> = {
  ...
  in_progress:       { label: "Em Andamento",       color: "bg-red-100 text-rose-700",     icon: HardHat },
...
const STATUS_TRANSITIONS: Record<string, { label: string; next: string; color: string }[]> = {
  ...
  waiting_parts: [
    { label: "Retomar Andamento", next: "in_progress", color: "bg-red-100 text-rose-700 hover:bg-red-200" },
    { label: "Marcar como Concluído", next: "finished", color: "bg-emerald-600 text-white hover:bg-emerald-700" },
  ],
}
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="text-sm text-slate-400 flex items-center gap-1">
          <Link href={PROJECTS_PATH} className="hover:text-rose-600 transition-colors">Projetos PPCI</Link>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 rounded-2xl bg-red-50 dark:bg-rose-900/20 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <Badge className="bg-red-100 text-rose-700 font-bold">PPCI</Badge>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
                ...
                {comments.length === 0 ? (
                  ...
                  comments.map((comment: any) => (
                    <div key={comment.id} className="flex gap-3">
                      <div className="w-8 h-8 rounded-full bg-red-100 dark:bg-rose-900/30 flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  size="icon"
                  className="h-full px-4 bg-rose-600 hover:bg-rose-700 text-white flex-shrink-0"
