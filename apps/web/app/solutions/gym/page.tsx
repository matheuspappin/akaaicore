      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 font-bold text-2xl tracking-tight text-white hover:opacity-80 transition-opacity">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">
            AKAAI <span className="text-red-400 font-black">Fit</span>
          </span>
        </Link>
    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-slate-950/90 text-white">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Matrículas, turmas, frequência de membros, pagamentos e comunicação com responsáveis — tudo em um só lugar. Foque na dança, não na burocracia.
          </motion.p>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight text-white">
            Tudo na palma da mão do <span className="text-red-400">Instrutor</span>
          </h2>
        ...
        <div className="grid md:grid-cols-12 gap-8 items-center max-w-6xl mx-auto">
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col h-full">
                    ...
                    <div className="space-y-2 flex-1 overflow-auto">
                      {[
                        ...
                        <div key={membro.name} className={cn(
                          "bg-white p-3 rounded-xl shadow-sm flex items-center justify-between border-l-4",
                          membro.present ? "border-l-emerald-500" : "border-l-red-400"
                        )}>
                          <div className="flex items-center gap-2">
                            <div className={cn(
                              "w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold text-white",
                              membro.present ? "bg-emerald-500" : "bg-slate-300"
                            )}>
                              {membro.name[0]}
                            </div>
                            <span className="text-sm font-semibold text-slate-700">{membro.name}</span>
                          </div>
                          {membro.present
                      ...
                      {[
                        ...
                        <div key={turma.name} className={cn("bg-white p-4 rounded-2xl shadow-sm border-l-4", turma.color)}>
                          ...
                          <div className="flex items-center justify-between mt-1">
                            ...
                            <div className="flex items-center gap-1 text-xs text-slate-500">
                              <Users className="w-3 h-3" /> {turma.students} membros
                            </div>
                          </div>
          ...
          <div className="md:col-span-7 space-y-6">
            {[
              { id: 'chamada', title: 'Chamada Digital', desc: 'Frequência em segundos, sem papel. Histórico completo por membro.', icon: ClipboardList },
              { id: 'turma', title: 'Agenda de Turmas', desc: 'Visualize todas as turmas do dia com horários e número de membros.', icon: Calendar },
              { id: 'qrcode', title: 'Check-in por QR Code', desc: 'Membros fazem check-in autônomo na entrada do academia.', icon: Smartphone }
            ].map((feature) => (
              <div
                key={feature.id}
              ...
              <div className="w-full h-full bg-slate-50 pt-10 pb-4 px-4 flex flex-col">
                ...
                <div className="bg-red-700 p-4 rounded-2xl shadow-xl border border-red-600 mb-4">
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-sm text-white">Fitness/Academia — Portal</span>
...
function ManagementDashboard() {
  const stats = [
    { label: "Membros Ativos", value: "124", icon: Users, color: "text-red-500", trend: "+8 este mês" },
  ...
  const modules = [
    ...
    { label: "Matrículas", icon: UserPlus, color: "bg-teal-600", shadow: "shadow-teal-500/30", description: "Fluxo de captação e onboarding de novos membros." },
    ...
    { label: "Gamificação", icon: Trophy, color: "bg-yellow-500", shadow: "shadow-yellow-500/30", description: "Rankings, conquistas e engajamento dos membros." },
  ]
    ...
    <section id="management" className="py-24 bg-slate-950/90 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight text-white">
            Controle total do seu <span className="text-red-400">Academia</span>
          </h2>
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
        ...
        <div className="text-center mb-20">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-lg leading-relaxed">
              A plataforma mais completa para modernizar a gestão do seu fitness/academia e encantar membros e responsáveis.
            </p>
          </motion.div>
        </div>
...
function PricingSection() {
  const highlights = [
    ...
    { icon: "🎯", label: "Personalização total", desc: "Sistema configurado para o fluxo do seu academia" },
  ]
    ...
    <section id="pricing" className="py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
        ...
        <p className="text-slate-500 max-w-2xl mx-auto text-lg mb-16">
          O Fitness/Academia é implantado com suporte especializado. Entre em contato para que nossa equipe entenda o seu academia e configure a plataforma perfeita para vocês.
        </p>
        ...
        <div className="bg-gradient-to-br from-red-600 to-pink-600 rounded-3xl p-10 text-white shadow-2xl shadow-red-500/20">
          <h3 className="text-2xl font-black mb-3">Pronto para transformar seu academia?</h3>
          <p className="text-violet-100 mb-8">
            Fale com nosso time e receba uma demonstração exclusiva do Fitness/Academia para o seu academia.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/5511999999999?text=Olá! Tenho interesse no Fitness/Academia para meu fitness/academia."
              target="_blank"
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-pink-400">seu academia?</span>
          </h2>
          <p className="text-slate-400 text-xl max-w-2xl mx-auto mb-12">
            Junte-se a centenas de academias que já modernizaram sua gestão com o Fitness/Academia.
          </p>
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12 pb-12 border-b border-white/5">
          <div className="md:col-span-5 space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
              A plataforma definitiva para gestão de fitness/academia. 
              Foque na arte e na evolução dos seus membros, nós cuidamos da burocracia.
            </p>
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="text-slate-400 text-xs leading-relaxed">
              O ecossistema **akaaicore** fornece a infraestrutura robusta, modular e baseada em IA que alimenta o Fitness/Academia, 
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href="/solutions/gym/login" className="text-slate-500 hover:text-red-400 text-sm transition-colors flex items-center gap-2 group">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-4">
          <p className="text-slate-600 text-[10px] uppercase tracking-[0.2em] font-black">
            © {new Date().getFullYear()} Fitness/Academia — powered by akaaicore. Todos os direitos reservados.
          </p>
