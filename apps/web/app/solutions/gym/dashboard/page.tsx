...
function InviteCodeCard({ type, label, description, color, borderColor, titleColor, buttonColor, registerPath = "/solutions/gym/register" }: InviteCodeCardProps) {
  ...
  const statCards = [
    {
      ...
      href: "/solutions/gym/dashboard/alunos"
    },
    {
      label: "Professores",
      ...
      href: "/solutions/gym/dashboard/professores"
    },
    {
      label: "Turmas Ativas",
      ...
      href: "/solutions/gym/dashboard/turmas"
    },
    {
      ...
      href: "/solutions/gym/dashboard/financeiro"
    },
  ]

  const quickActions = [
    { label: "Aulas ao Vivo", sub: "Monitore quem está no estúdio agora", href: "/solutions/gym/dashboard/ao-vivo", icon: Video, color: "bg-rose-600 hover:bg-rose-700" },
    { label: "Novo Aluno", sub: "Matricular aluno", href: "/solutions/gym/dashboard/alunos", icon: UserPlus, color: "bg-red-600 hover:bg-red-700" },
    { label: "Nova Turma", sub: "Criar turma de dança", href: "/solutions/gym/dashboard/turmas", icon: Calendar, color: "bg-pink-600 hover:bg-pink-700" },
    { label: "Financeiro", sub: "Cobranças e pagamentos", href: "/solutions/gym/dashboard/financeiro", icon: DollarSign, color: "bg-emerald-600 hover:bg-emerald-700" },
  ]
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Button type="button" className="bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl shadow-lg shadow-red-600/20" asChild>
          <Link href="/solutions/gym/dashboard/alunos">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-white dark:bg-slate-900/50 shadow-sm border border-slate-200 dark:border-white/10">
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            ...
            <Link href="/solutions/gym/dashboard/turmas">
            ...
            {loading ? (
              ...
              <div className="space-y-0.5">
                {stats.turmasDeHoje.map((t) => (
                  <Link
                    key={t.id}
                    href={`/solutions/gym/dashboard/turmas/${t.id}/chamada`}
        ...
        <div className="space-y-4">
          ...
          <Card className="bg-gradient-to-br from-red-600 to-pink-600 text-white border-none shadow-lg">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <Button type="button" size="sm" variant="secondary" className="font-bold rounded-xl" asChild>
                <Link href="/solutions/gym/dashboard/gamificacao">Ver</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-slate-900/50 shadow-sm border border-indigo-200 dark:border-indigo-600/20">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <Link href="/solutions/gym/dashboard/leads" className="ml-auto">
