...
import { Flower2,  useState, useEffect, useRef } from "react"
...
import {
  Check, ArrowRight, ArrowLeft, Flower2, CreditCard, Calendar,
  DollarSign, Layout,
      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 font-bold text-2xl tracking-tight text-white hover:opacity-80 transition-opacity">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">
            Yoga <span className="text-indigo-400 font-black"></span>
          </span>
        </Link>
                ...
                {activeTab === 'chamada' && (
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col h-full">
                    <div className="bg-white p-4 rounded-2xl shadow-sm mb-4 flex items-center justify-between">
                      ...
                      <Badge className="bg-indigo-100 text-indigo-600 border-none">Turma Ballet</Badge>
                    </div>
    ...
    <section id="management" className="py-24 bg-slate-950/90 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight text-white">
            Controle total do seu <span className="text-indigo-400">Studio</span>
          </h2>
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
...
function FeatureGrid() {
  const features = [
    ...
    { title: "Multi-Estilo", description: "Ballet, jazz, funk, sapateado, contemporâneo e muito mais.", icon: Flower2, color: "from-amber-500 to-orange-400" },
  ]
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Badge className="bg-indigo-100 text-indigo-600 border-none px-4 py-1.5 mb-6 uppercase tracking-[0.2em] text-[10px] font-black shadow-sm">
              Recursos
            </Badge>
  ...
  return (
    <section id="pricing" className="py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
        <Badge className="bg-indigo-100 text-indigo-600 border-none px-4 py-1.5 mb-6 uppercase tracking-[0.2em] text-[10px] font-black">
          Implementação
        </Badge>
        <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">
        ...
        <div className="bg-gradient-to-br from-indigo-600 to-pink-600 rounded-3xl p-10 text-white shadow-2xl shadow-indigo-500/20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-white text-indigo-700 hover:bg-indigo-50 font-bold h-14 px-8 rounded-2xl transition-all shadow-lg"
            >
              <Flower2 className="w-5 h-5" />
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-pink-400">seu estúdio?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12 pb-12 border-b border-white/5">
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href="/solutions/yoga/login" className="text-slate-500 hover:text-indigo-400 text-sm transition-colors flex items-center gap-2 group">
