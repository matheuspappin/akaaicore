      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {/* Botão PDV */}
            <Link href={`/solutions/interior_design/dashboard/vendas`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          {
            href: "/solutions/interior_design/dashboard/vendas",
            icon: ShoppingCart,
          ...
          {
            href: "/solutions/interior_design/dashboard/os",
            icon: ClipboardList,
          ...
          {
            href: "/solutions/interior_design/dashboard/vistorias",
            icon: Calendar,
            label: "Agendar Vistoria",
            desc: "Agenda vistoria técnica",
            color: "text-slate-600",
            bg: "bg-red-50 dark:bg-slate-600/10 border-red-200 dark:border-slate-600/30",
          },
        ].map((item) => (
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-xl bg-red-100 dark:bg-slate-600/15 flex items-center justify-center text-slate-600 font-black text-lg flex-shrink-0">
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      onClick={(e) => {
                        e.stopPropagation()
                        window.location.href = '/solutions/interior_design/dashboard/vendas'
                      }}
                    ...
                    <Link
                      href="/solutions/interior_design/dashboard/vistorias"
                      onClick={(e) => e.stopPropagation()}
                      className="flex-1 flex items-center justify-center gap-1 text-xs font-bold py-1.5 rounded-lg bg-red-50 dark:bg-slate-600/10 text-slate-700 dark:text-slate-400 hover:bg-red-100 dark:hover:bg-slate-600/20 transition-colors"
                    >
