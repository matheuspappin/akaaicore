  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        setSuccess(true)
        setTimeout(() => {
          router.push("/solutions/cleaning/dashboard/vistorias")
        }, 1500)
      }
    } finally {
      setLoading(false)
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link href="/solutions/cleaning/dashboard/vistorias">
        ...
        <CardContent className="space-y-5">
          ...
          <div>
            <Label className="text-sm font-bold text-slate-700 dark:text-slate-300 flex items-center gap-2">
              ...
              Data e Hora da Vistoria <span className="text-sky-500">*</span>
            </Label>
            <Input
              type="datetime-local"
              className="mt-1.5"
      ...
      <div className="flex gap-3 pb-8">
        <Link href="/solutions/cleaning/dashboard/vistorias" className="flex-1">
