...
export default function TechnicianPerfilPage() {
  ...
  return (
    <div className="space-y-6 pb-20 md:pb-0">
      ...
      {/* Avatar + Info */}
      <Card className="bg-gradient-to-br from-orange-600 to-sky-600 border-none text-white">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          { label: "Vistorias", value: stats.vistorias, color: "text-sky-600" },
        ].map(s => (
        ...
        <CardContent>
          {loadingVinculo ? (
            ...
            <div className="space-y-4">
              ...
              <Button
                variant="outline"
                className="w-full text-sky-600 border-red-200 hover:bg-red-50 hover:border-sky-300 font-bold rounded-xl"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1.5">
                  O código é fornecido pelo administrador da empresa no painel ServiçosdeLimpeza.
                </p>
              </div>
