...
function OrdemCard({ ordem }: { ordem: Ordem }) {
  ...
  return (
    <Card className={cn(
      ...
      isVistoria ? "border-l-slate-500" : "border-l-blue-500"
    )}>
      <CardContent className="p-4 space-y-3">
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              {isVistoria && (
                <Badge className="text-xs border-0 bg-red-100 text-slate-700 font-bold">Vistoria</Badge>
              )}
            </div>
        ...
        {ordem.laudo_url && (
          <a href={ordem.laudo_url} target="_blank" rel="noopener noreferrer">
            <Button size="sm" className="w-full bg-slate-600 hover:bg-slate-700 text-white font-bold rounded-xl">
          ...
          <TabsList className="w-full">
            <TabsTrigger value="vistorias" className="flex-1">
              ...
              {data.vistorias.length > 0 && (
                <span className="ml-1.5 bg-slate-600 text-white text-[10px] font-bold rounded-full h-4 min-w-[16px] px-1 flex items-center justify-center">
