...
export default function DesenvolvimentoPrePage() {
  useEffect(() => {
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6">
        ...
        >
          <div className="flex flex-col items-center gap-4 mb-6">
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="h-14 md:h-16 min-w-[280px] md:min-w-[360px] w-full max-w-[360px] flex items-center justify-center overflow-visible" aria-label="Desenvolvimento">
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-md mx-auto font-medium">
            Gestão inteligente para Desenvolvimento
          </p>
        </motion.div>
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href="/solutions/dev_studio/landing">
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href="/solutions/dev_studio/login">
              Já tenho conta
            </Link>
          </Button>
        </motion.div>
