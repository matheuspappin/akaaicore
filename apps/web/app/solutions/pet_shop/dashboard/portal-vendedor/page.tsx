      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {/* Botão PDV */}
            <Link href={`/solutions/pet_shop/dashboard/vendas`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          {
            href: "/solutions/pet_shop/dashboard/vendas",
            icon: ShoppingCart,
          ...
          {
            href: "/solutions/pet_shop/dashboard/os",
            icon: ClipboardList,
          ...
          {
            href: "/solutions/pet_shop/dashboard/vistorias",
            icon: Calendar,
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      onClick={(e) => {
                        e.stopPropagation()
                        window.location.href = '/solutions/pet_shop/dashboard/vendas'
                      }}
