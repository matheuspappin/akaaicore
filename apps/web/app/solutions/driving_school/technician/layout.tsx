...
const navItems = [
  { href: "/solutions/driving_school/technician", label: "Dashboard", icon: LayoutDashboard },
  { href: "/solutions/driving_school/technician/os", label: "Minhas OS", icon: ClipboardList },
  { href: "/solutions/driving_school/technician/scanner", label: "Scanner", icon: QrCode },
  { href: "/solutions/driving_school/technician/perfil", label: "Meu Perfil", icon: UserCircle },
]
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between p-4 border-b border-white/10">
        <Link href="/solutions/driving_school" className="flex items-center gap-2">
          ...
          {(!collapsed || isMobile) && (
            <div>
              <span className="font-black text-white tracking-tighter text-xs block">AutoEscola</span>
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-slate-950 border-b border-white/10 flex items-center justify-between px-4 z-40">
        <div className="flex items-center gap-2">
          ...
          <span className="font-black text-white text-sm">AutoEscola <span className="text-orange-400">Técnico</span></span>
        </div>
