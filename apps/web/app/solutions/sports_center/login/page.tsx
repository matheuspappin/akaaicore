...
function LoginContent() {
  ...
  function redirectByRole(userRole: string) {
    ...
    else if (userRole === 'student') router.push("/solutions/sports_center/student")
    else if (userRole === 'teacher') router.push("/solutions/sports_center/teacher")
    else if (userRole === 'finance') router.push("/solutions/sports_center/dashboard/financeiro")
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex relative font-sans">
      <button
        type="button"
        onClick={() => router.push("/solutions/sports_center")}
      ...
      {/* Left Side — CentroEsportivo Branding */}
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-slate-950 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-md">
          <div className="lg:hidden mb-12 text-center">
            <Link href="/solutions/sports_center" className="inline-flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-blue-600 flex items-center justify-center shadow-lg shadow-blue-600/20">
                <Music className="w-6 h-6 text-white" />
              </div>
              <span className="text-2xl font-black text-white tracking-tighter">
                AKAAI <span className="text-blue-500">Court</span>
              </span>
            </Link>
          </div>
          ...
          <Card className="relative overflow-hidden bg-slate-900/80 backdrop-blur-xl border border-white/[0.08] shadow-2xl shadow-black/50">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-72 h-px bg-gradient-to-r from-transparent via-blue-500/60 to-transparent" />
            ...
            <CardContent className="px-6 pb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/forgot-password?returnTo=/solutions/sports_center/login" className="text-xs text-blue-500/80 hover:text-blue-400 transition-colors">
                      Esqueceu?
                    </Link>
                  </div>
                  <div className="relative">
              ...
              <div className="mt-6 pt-5 border-t border-white/5 space-y-4">
                <p className="text-center text-sm text-slate-500">
                  Não possui conta?{" "}
                  <Link href="/solutions/sports_center/register" className="text-blue-500 hover:text-blue-400 font-medium transition-colors">
                    Criar conta grátis
                  </Link>
                </p>
                <Link
