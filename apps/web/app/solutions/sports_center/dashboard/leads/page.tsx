...
const stageMap: Record<string, { label: string; color: string }> = {
  ...
  contacted:       { label: "Contactado",  color: "bg-violet-100 text-blue-700 dark:bg-blue-600/20 dark:text-blue-400" },
...
export default function LeadsPage() {
  ...
  const handleConvidarLead = (lead: any) => {
    ...
    const link = `${origin}/solutions/sports_center/register?role=student&code=${inviteCode}`
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        copiedLinkId === lead.id
                          ...
                          : "text-blue-600 border-violet-200 hover:bg-violet-50 dark:border-blue-600/30 dark:text-blue-400 dark:hover:bg-blue-600/10"
                      )}
                    >
                      {copiedLinkId === lead.id
