...
export default function CentroEsportivoAttendancePage() {
  ...
  const loadAttendanceData = async () => {
    try {
      ...
      if (classError || !classData) {
        ...
        router.push("/solutions/sports_center/dashboard/turmas")
        return
      }
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Badge className="bg-violet-100 text-blue-700">
                {students.length === 0
                  ? "Sem alunos na lista"
                  : students.length === 1
                    ? "1 aluno na lista"
                    ...
                    <div key={student.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center gap-3">
                        <Avatar className="h-10 w-10">
                          <AvatarFallback className="bg-violet-100 text-blue-600">
                ...
                {teacherLessonAmount === 0 && (
                  <div className="mt-3 flex gap-2 rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-950 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-100">
                    ...
                    <span>
                      ...
                      <Link
                        href="/solutions/sports_center/dashboard/pagamentos-professores"
