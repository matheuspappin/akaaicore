...
function InviteCodeCard({ type, label, description, color, borderColor, titleColor, buttonColor, registerPath = "/solutions/sports_center/register" }: InviteCodeCardProps) {
  ...
  const statCards = [
    {
      ...
      href: "/solutions/sports_center/dashboard/alunos"
    },
    {
      label: "Professores",
      ...
      href: "/solutions/sports_center/dashboard/professores"
    },
    {
      label: "Turmas Ativas",
      ...
      href: "/solutions/sports_center/dashboard/turmas"
    },
    {
      ...
      href: "/solutions/sports_center/dashboard/financeiro"
    },
  ]

  const quickActions = [
    { label: "Aulas ao Vivo", sub: "Monitore quem está no estúdio agora", href: "/solutions/sports_center/dashboard/ao-vivo", icon: Video, color: "bg-rose-600 hover:bg-rose-700" },
    { label: "Novo Aluno", sub: "Matricular aluno", href: "/solutions/sports_center/dashboard/alunos", icon: UserPlus, color: "bg-blue-600 hover:bg-blue-700" },
    { label: "Nova Turma", sub: "Criar turma de dança", href: "/solutions/sports_center/dashboard/turmas", icon: Calendar, color: "bg-pink-600 hover:bg-pink-700" },
    { label: "Financeiro", sub: "Cobranças e pagamentos", href: "/solutions/sports_center/dashboard/financeiro", icon: DollarSign, color: "bg-emerald-600 hover:bg-emerald-700" },
  ]
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Button type="button" className="bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-600/20" asChild>
          <Link href="/solutions/sports_center/dashboard/alunos">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-white dark:bg-slate-900/50 shadow-sm border border-slate-200 dark:border-white/10">
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            ...
            <Link href="/solutions/sports_center/dashboard/turmas">
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-10">
                ...
                <Button type="button" size="sm" className="bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl" asChild>
                  <Link href="/solutions/sports_center/dashboard/turmas">
              ...
              <div className="space-y-0.5">
                {stats.turmasDeHoje.map((t) => (
                  <Link
                    key={t.id}
                    href={`/solutions/sports_center/dashboard/turmas/${t.id}/chamada`}
                    className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group"
                  >
                    <div className="w-10 h-10 rounded-lg bg-violet-100 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0">
        ...
        <div className="space-y-4">
          ...
          <Card className="bg-gradient-to-br from-blue-600 to-pink-600 text-white border-none shadow-lg">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <Button type="button" size="sm" variant="secondary" className="font-bold rounded-xl" asChild>
                <Link href="/solutions/sports_center/dashboard/gamificacao">Ver</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <InviteCodeCard
            ...
            color="bg-gradient-to-br from-violet-50 to-purple-50 dark:from-blue-600/10 dark:to-purple-600/10"
            borderColor="border border-violet-200 dark:border-blue-600/20"
          ...
          <Card className="bg-white dark:bg-slate-900/50 shadow-sm border border-indigo-200 dark:border-indigo-600/20">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <Link href="/solutions/sports_center/dashboard/leads" className="ml-auto">
