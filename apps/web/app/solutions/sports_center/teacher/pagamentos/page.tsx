...
export default function TeacherPagamentosPage() {
  ...
  const handleStripeOnboarding = async () => {
    ...
    try {
      const returnUrl = `${window.location.origin}/solutions/sports_center/teacher/pagamentos`
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-violet-200 dark:border-blue-500/30">
        <CardHeader>
        ...
        <CardContent className="flex flex-wrap items-center gap-3">
          {stripeStatus?.stripe_account_id ? (
            ...
            <Button onClick={handleStripeOnboarding} disabled={stripeLinkLoading} className="bg-blue-600 hover:bg-blue-700">
