...
const COLORS = ["border-l-pink-500", "border-l-zinc-500", "border-l-indigo-500", "border-l-emerald-500", "border-l-amber-500"]
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link href="/solutions/photography/teacher/chamada">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          { label: "Total Alunos", value: loading ? '—' : String(stats.totalAlunos), icon: Users, color: "text-zinc-600 bg-violet-100 dark:bg-zinc-600/20" },
      ...
      <Card className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10">
        <CardHeader className="flex flex-row items-center justify-between pb-3">
          ...
          <Link href="/solutions/photography/teacher/turmas">
            ...
            todayClasses.map((turma, i) => (
              <div key={turma.id} className={cn("p-4 rounded-xl bg-slate-50 dark:bg-white/5 border-l-4", COLORS[i % COLORS.length])}>
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/solutions/photography/teacher/chamada?classId=${turma.id}`}>
