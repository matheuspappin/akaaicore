...
function LoginContent() {
  ...
  function redirectByRole(userRole: string) {
    ...
    else if (userRole === 'student') router.push("/solutions/photography/student")
    else if (userRole === 'teacher') router.push("/solutions/photography/teacher")
    else if (userRole === 'finance') router.push("/solutions/photography/dashboard/financeiro")
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex relative font-sans">
      <button
        type="button"
        onClick={() => router.push("/solutions/photography")}
      ...
      {/* Left Side — Fotografia(Escola) Branding */}
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-slate-950 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-md">
          <div className="lg:hidden mb-12 text-center">
            <Link href="/solutions/photography" className="inline-flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-zinc-600 flex items-center justify-center shadow-lg shadow-zinc-600/20">
                <Music className="w-6 h-6 text-white" />
              </div>
              <span className="text-2xl font-black text-white tracking-tighter">
                AKAAI <span className="text-zinc-500">Focus</span>
              </span>
            </Link>
          </div>
          ...
          <Card className="relative overflow-hidden bg-slate-900/80 backdrop-blur-xl border border-white/[0.08] shadow-2xl shadow-black/50">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-72 h-px bg-gradient-to-r from-transparent via-zinc-500/60 to-transparent" />
            ...
            <CardContent className="px-6 pb-8">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={cn(
                        ...
                        role === 'admin' && "bg-zinc-500/20 text-zinc-400",
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/forgot-password?returnTo=/solutions/photography/login" className="text-xs text-zinc-500/80 hover:text-zinc-400 transition-colors">
                      Esqueceu?
                    </Link>
                  </div>
                  <div className="relative">
              ...
              <div className="mt-6 pt-5 border-t border-white/5 space-y-4">
                <p className="text-center text-sm text-slate-500">
                  Não possui conta?{" "}
                  <Link href="/solutions/photography/register" className="text-zinc-500 hover:text-zinc-400 font-medium transition-colors">
                    Criar conta grátis
                  </Link>
                </p>
                <Link
