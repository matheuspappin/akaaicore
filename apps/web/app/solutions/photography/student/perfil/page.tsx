  ...
  return (
    <div className="space-y-6 max-w-xl pb-20 md:pb-0">
      ...
      <div className="flex items-center gap-4">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-zinc-500 to-purple-600 flex items-center justify-center text-white text-3xl font-black shadow-lg shadow-zinc-600/20">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1 flex-wrap">
            <span className="inline-block px-2 py-0.5 rounded-full bg-violet-100 dark:bg-zinc-600/20 text-zinc-700 dark:text-zinc-400 text-[10px] font-black uppercase tracking-widest">
              Aluno
            </span>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1.5">
                  ...
                  <Button
                    className="bg-zinc-600 hover:bg-zinc-700 text-white font-bold rounded-xl px-5"
                ...
                <p className="text-xs text-slate-400 mt-1.5">
                  O código é fornecido pelo administrador do estúdio no painel Fotografia(Escola).
                </p>
              </div>
              <Button
                className="w-full bg-zinc-600 hover:bg-zinc-700 text-white font-bold rounded-xl"
                onClick={handleVincular}
                disabled={vinculando || !inviteCode.trim()}
              >
                {vinculando ? (
      ...
      <Card className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10">
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            onClick={handleSave}
            disabled={saving}
            className="bg-zinc-600 hover:bg-zinc-700 text-white font-bold rounded-xl w-full h-11"
          >
      ...
      <div className="space-y-3">
        ...
        <Link href="/solutions/photography/student/perfil/privacidade">
        ...
        <Link href="/solutions/photography/student/perfil/preferencias">
          <Button variant="ghost" className="w-full justify-between bg-white dark:bg-slate-900/50 h-14 px-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 border border-slate-200 dark:border-white/10 rounded-xl">
            <div className="flex items-center gap-3">
        ...
        <Button
          ...
          onClick={async () => {
            ...
            window.location.href = "/solutions/photography/login"
          }}
        >
          <div className="flex items-center gap-3">
