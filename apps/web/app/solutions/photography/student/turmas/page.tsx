    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <Card className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 overflow-hidden">
          <div className="h-1.5 bg-gradient-to-r from-zinc-500 to-pink-500" />
          <CardContent className="flex flex-col items-center justify-center py-20 text-center px-6">
            <div className="w-20 h-20 rounded-2xl bg-violet-100 dark:bg-zinc-900/30 flex items-center justify-center mb-4">
            ...
            <Link href="/solutions/photography/student/turmas/catalogo">
              <Button className="bg-zinc-600 hover:bg-zinc-700 text-white font-bold rounded-xl gap-2">
        ...
        <>
                ...
                <CardContent className="p-5">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      {turma.dance_style && (
                        <p className="text-xs text-zinc-600 dark:text-zinc-400 font-bold mt-0.5">{turma.dance_style}</p>
                      )}
                    </div>
                    {turma.level && (
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full mt-4 h-10 rounded-xl font-bold text-sm border-violet-200 dark:border-zinc-700/50 text-zinc-600 dark:text-zinc-400 hover:bg-violet-50 dark:hover:bg-violet-950/30"
          ...
          <Link href="/solutions/photography/student/turmas/catalogo">
            <Button
              variant="outline"
              className="w-full border-dashed border-2 border-violet-200 dark:border-zinc-700/40 text-zinc-600 dark:text-zinc-400 bg-violet-50/50 dark:bg-violet-950/20 hover:bg-violet-50 dark:hover:bg-violet-950/40 h-12 rounded-xl font-bold gap-2 transition-all"
            >
