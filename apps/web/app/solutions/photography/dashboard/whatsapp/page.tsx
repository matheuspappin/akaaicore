    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {[
          ...
          { icon: Send, title: "Cobranças de Mensalidade", desc: "Lembrete automático antes e após vencimento da mensalidade.", color: "text-zinc-500 bg-violet-100 dark:bg-zinc-600/20", status: "Automático", statusColor: "bg-emerald-100 text-emerald-700 dark:bg-emerald-600/20 dark:text-emerald-400" },
