      ...
      <div className="flex gap-2 flex-wrap">
        {SUGGESTIONS.map(s => (
          <button
            key={s}
            onClick={() => send(s)}
            className="px-3 py-1.5 rounded-full text-xs font-bold bg-violet-100 text-zinc-700 dark:bg-zinc-600/20 dark:text-zinc-400 hover:bg-violet-200 dark:hover:bg-zinc-600/30 transition-colors"
          >
            {s}
          </button>
        ))}
          ...
          {messages.map((msg) => (
            ...
            >
              <div className={cn(
                ...
                msg.role === "assistant" ? "bg-zinc-600 text-white" : "bg-slate-200 dark:bg-slate-700"
              )}>
        ...
        <div className="p-4 border-t border-slate-100 dark:border-white/10">
          ...
          >
            ...
            <Button
              ...
              className="bg-zinc-600 hover:bg-zinc-700 text-white rounded-xl h-11 px-4"
            >
