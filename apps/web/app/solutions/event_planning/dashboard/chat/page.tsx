    ...
    return (
      <div className="flex justify-center items-center h-[calc(100vh-120px)]">
        <div className="flex flex-col items-center gap-3 text-slate-500">
          <div className="w-8 h-8 border-2 border-fuchsia-600/30 border-t-fuchsia-600 rounded-full animate-spin" />
              ...
              chatSessions.map((session) => (
                <div
                  ...
                  className={cn(
                    ...
                    currentSessionId === session.id
                      ? "bg-fuchsia-600/10 text-fuchsia-600 dark:text-fuchsia-400 border border-fuchsia-600/20"
        ...
        <div className="flex-1 flex flex-col bg-white dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-white/10 overflow-hidden shadow-sm min-w-0">
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {messages.map((msg) => (
              ...
              >
                {msg.role === "assistant" && (
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-fuchsia-600 flex items-center justify-center text-white flex-shrink-0 mr-2 mt-1">
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-fuchsia-600 flex items-center justify-center text-white flex-shrink-0 mr-2">
                  <Sparkles className="w-4 h-4" />
                </div>
            ...
            <div className="px-4 pb-3 flex flex-wrap gap-2">
              {sugestoes.map((s) => (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-white/5 hover:bg-red-50 dark:hover:bg-fuchsia-600/10 hover:text-fuchsia-600 text-xs font-bold text-slate-600 dark:text-slate-300 transition-all border border-slate-200 dark:border-white/10"
                >
          ...
          <div className="p-3 border-t border-slate-100 dark:border-white/5 flex gap-2">
            ...
            <Button
              ...
              className="bg-fuchsia-600 hover:bg-fuchsia-700 text-white font-bold px-3"
            >
