...
function InviteCodeCard() {
  ...
  const handleCopyLink = () => {
    ...
    const link = `${origin}/solutions/event_planning/register?role=teacher&code=${inviteCode}`
  ...
  return (
    <Card className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-600/10 dark:to-fuchsia-600/10 border border-orange-200 dark:border-orange-600/20 shadow-sm">
            ...
            <Card key={tecnico.id} className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-5">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-fuchsia-500 to-orange-600 flex items-center justify-center text-white font-black text-lg flex-shrink-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem className="text-fuchsia-600">
