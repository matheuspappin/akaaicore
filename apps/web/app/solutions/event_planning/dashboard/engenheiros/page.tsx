...
const STATUS_MAP: Record<string, { label: string; className: string }> = {
  ...
  in_progress:       { label: "Em Andamento", className: "bg-red-100 text-fuchsia-700 dark:bg-fuchsia-600/20 dark:text-fuchsia-400" },
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
            <HardHat className="w-6 h-6 text-fuchsia-600" />
            Engenheiros
          </h1>
                ...
                <CardContent className="p-5">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-fuchsia-500 to-fuchsia-700 flex items-center justify-center text-white font-black text-lg flex-shrink-0">
                  ...
                  <div className="mt-4 pt-4 border-t border-slate-100 dark:border-white/5">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-black text-fuchsia-600">{stats.progress}%</span>
                    </div>
