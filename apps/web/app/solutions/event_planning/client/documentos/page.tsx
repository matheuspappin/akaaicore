...
function OrdemCard({ ordem }: { ordem: Ordem }) {
  ...
  return (
    <Card className={cn(
      ...
      isVistoria ? "border-l-fuchsia-500" : "border-l-blue-500"
    )}>
      <CardContent className="p-4 space-y-3">
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              {isVistoria && (
                <Badge className="text-xs border-0 bg-red-100 text-fuchsia-700 font-bold">Vistoria</Badge>
              )}
            </div>
        ...
        {ordem.laudo_url && (
          <a href={ordem.laudo_url} target="_blank" rel="noopener noreferrer">
            <Button size="sm" className="w-full bg-fuchsia-600 hover:bg-fuchsia-700 text-white font-bold rounded-xl">
              ...
              <div key={doc.id} className="flex items-center justify-between p-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  ...
                  <a href={doc.file_url} target="_blank" rel="noopener noreferrer">
                    <Button variant="ghost" size="icon" className="h-7 w-7 text-fuchsia-600">
          ...
          <TabsList className="w-full">
            <TabsTrigger value="vistorias" className="flex-1">
              ...
              {data.vistorias.length > 0 && (
                <span className="ml-1.5 bg-fuchsia-600 text-white text-[10px] font-bold rounded-full h-4 min-w-[16px] px-1 flex items-center justify-center">
