...
const navItems = [
  { href: "/solutions/beauty/client", label: "Início", icon: LayoutDashboard },
  { href: "/solutions/beauty/client/extintores", label: "Meus Extintores", icon: Package },
  { href: "/solutions/beauty/client/documentos", label: "Documentos", icon: FileText },
  { href: "/solutions/beauty/client/perfil", label: "Meu Perfil", icon: UserCircle },
]
      ...
      <nav className="hidden md:flex bg-white dark:bg-slate-900/50 border-b border-slate-200 dark:border-white/10 px-4 md:px-6">
        <div className="flex gap-1 max-w-4xl w-full">
          {navItems.map((item) => {
            const isActive =
              pathname === item.href ||
              (item.href !== "/solutions/beauty/client" &&
