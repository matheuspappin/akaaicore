...
import { Sparkles,  useState, useEffect } from "react"
...
import { 
  ...
  DollarSign, Layout, 
  ChevronRight, Menu, X, Truck, Sparkles,
  ...
  return (
    <header className={cn(
      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link href="/solutions/beauty/landing" className="flex items-center gap-2.5 font-bold text-2xl tracking-tight text-white hover:opacity-90 transition-opacity">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-cyan-200/90">
            AKAAI <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-red-400 font-black">Glow</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Link href="/solutions/beauty/login" className="hidden sm:block">
          ...
          <Link href="/solutions/beauty/register">
          ...
          >
            <div className="flex flex-col p-6 space-y-4 font-semibold text-white">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <Link href="/solutions/beauty/login" onClick={() => setMobileMenuOpen(false)}>
                ...
                <Link href="/solutions/beauty/register" onClick={() => setMobileMenuOpen(false)}>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight text-white">
            Tecnologia na palma da mão do <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-red-500">Profissional</span>
          </h2>
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <a href="https://wa.me/5511999999999?text=Olá! Tenho interesse no FireControl para minha empresa de extintores." target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-white hover:bg-white/95 text-slate-900 font-bold h-14 px-8 rounded-2xl transition-all duration-200 shadow-[0_0_0_1px_rgba(255,255,255,0.2),0_12px_40px_-8px_rgba(0,0,0,0.4)] hover:shadow-[0_0_0_1px_rgba(255,255,255,0.3),0_16px_50px_-8px_rgba(239,68,68,0.2)] hover:scale-[1.02] group">
                <Sparkles className="w-5 h-5 group-hover:rotate-[-8deg] transition-transform" />
  ...
  return (
    <footer className="text-slate-400 py-12 border-t border-white/10 text-center backdrop-blur-sm">
      <div className="flex items-center justify-center gap-2 mb-6 font-bold text-xl text-white">
        ...
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-red-500 to-cyan-400">AKAAI Glow</span>
      </div>
