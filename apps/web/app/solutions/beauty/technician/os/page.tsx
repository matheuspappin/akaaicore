      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            {isVistoria ? <Calendar className="w-5 h-5 text-pink-600" /> : <Wrench className="w-5 h-5 text-orange-600" />}
            {os.title}
              ...
              <div className="space-y-1.5">
                ...
                {checklist.length > 6 && (
                  <button
                    ...
                    className="w-full text-xs text-pink-600 font-bold flex items-center justify-center gap-1 py-2"
                  >
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex-1">
                            <div className="flex flex-wrap items-center gap-2 mb-1.5">
                              ...
                              {isVistoria && (
                                <Badge className="text-xs border-0 bg-red-100 text-pink-700">Vistoria</Badge>
                              )}
                              {os.priority === "urgente" && (
                          ...
                          <div className={cn(
                            ...
                            isVistoria ? "bg-red-50 dark:bg-pink-900/20" : "bg-orange-50 dark:bg-orange-900/20"
                          )}>
                            {isVistoria
