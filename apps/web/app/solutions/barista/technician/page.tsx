    ...
    <div className="space-y-8 pb-20 md:pb-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/solutions/barista/technician/scanner">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-white dark:bg-slate-900/50 shadow-sm border border-slate-200 dark:border-white/10">
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            ...
            <Link href="/solutions/barista/technician/os">
            ...
            {today.length === 0 ? (
              ...
              <div className="space-y-3">
                {today.slice(0, 4).map(os => (
                  <Link href="/solutions/barista/technician/os" key={os.id}>
                    <div className={cn(
                      ...
                      os.project_type === "vistoria" ? "border-l-amber-500" : "border-l-orange-500"
                    )}>
                      <div className={cn(
      ...
      <Link href="/solutions/barista/technician/scanner">
        <Card className="bg-gradient-to-r from-orange-600 to-amber-600 text-white border-none shadow-xl cursor-pointer hover:shadow-2xl hover:scale-[1.01] transition-all">
