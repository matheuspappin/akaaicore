  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        setSuccess(true)
        setTimeout(() => {
          router.push("/solutions/barista/dashboard/vistorias")
        }, 1500)
      }
    } finally {
      setLoading(false)
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link href="/solutions/barista/dashboard/vistorias">
      ...
      <div className="flex gap-3 pb-8">
        <Link href="/solutions/barista/dashboard/vistorias" className="flex-1">
