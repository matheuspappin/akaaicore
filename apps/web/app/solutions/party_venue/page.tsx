...
import { FireControlLogoCanvas as EspaçodeEventosLogoCanvas } from "@/components/fire-protection/fire-control-logo-canvas"

import { OFFICIAL_LOGO } from "@/config/branding"

export default function EspaçodeEventosPrePage() {
  useEffect(() => {
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6">
        ...
        >
          <div className="flex flex-col items-center gap-4 mb-6">
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="h-14 md:h-16 min-w-[280px] md:min-w-[360px] w-full max-w-[360px] flex items-center justify-center overflow-visible" aria-label="EspaçodeEventos">
                <EspaçodeEventosLogoCanvas className="w-full h-full" text="EspaçodeEventos" />
              </div>
            </div>
          ...
          <p className="text-slate-300 text-lg md:text-xl max-w-md mx-auto font-medium">
            Gestão inteligente para Espaço de Eventos
          </p>
        </motion.div>
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href="/solutions/party_venue/landing">
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href="/solutions/party_venue/login">
              Já tenho conta
            </Link>
          </Button>
        </motion.div>
