...
import { Music,  useState, useEffect, useRef } from "react"
              ...
              <div className="w-full h-full bg-slate-50 pt-10 pb-4 px-4 flex flex-col">
                ...
                <div className="bg-violet-700 p-4 rounded-2xl shadow-xl border border-violet-600 mb-4">
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-sm text-white">AKAAI Music — Portal</span>
...
function FeatureGrid() {
  const features = [
    ...
    { title: "Multi-Instrumento", description: "Ballet, jazz, funk, sapateado, contemporâneo e muito mais.", icon: Music, color: "from-amber-500 to-orange-400" },
  ]
    ...
    <section id="pricing" className="py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
        ...
        <p className="text-slate-500 max-w-2xl mx-auto text-lg mb-16">
          O AKAAI Music é implantado com suporte especializado. Entre em contato para que nossa equipe entenda o seu estúdio e configure a plataforma perfeita para vocês.
        </p>
        ...
        <div className="bg-gradient-to-br from-violet-600 to-pink-600 rounded-3xl p-10 text-white shadow-2xl shadow-violet-500/20">
          ...
          <p className="text-violet-100 mb-8">
            Fale com nosso time e receba uma demonstração exclusiva do AKAAI Music para o seu estúdio.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/5511999999999?text=Olá! Tenho interesse no AKAAI Music para meu estúdio de dança."
              target="_blank"
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-slate-400 text-xl max-w-2xl mx-auto mb-12">
            Junte-se a centenas de estúdios que já modernizaram sua gestão com o AKAAI Music.
          </p>
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12 pb-12 border-b border-white/5">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="text-slate-400 text-xs leading-relaxed">
              O ecossistema **akaaicore** fornece a infraestrutura robusta, modular e baseada em IA que alimenta o AKAAI Music, 
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-4">
          <p className="text-slate-600 text-[10px] uppercase tracking-[0.2em] font-black">
            © {new Date().getFullYear()} AKAAI Music — powered by akaaicore. Todos os direitos reservados.
          </p>
