  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      await Promise.all([
        ...
        // Financeiro — busca cobranças do aluno via API EscoladeMúsica
        (async () => {
          try {
      ...
      {!loading && financeiro.hasDebito && (
        <Card className={cn(
          ...
          <CardContent className="p-4 flex items-center gap-4">
            ...
            <Link href="/solutions/music_school/student/financeiro">
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button type="button" variant="ghost" size="sm" className="text-violet-600 text-xs font-bold h-7" asChild>
              <Link href="/solutions/music_school/student/turmas">
