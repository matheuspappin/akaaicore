...
export default function PlanosPage() {
  ...
  const verifyPayment = async (sessionId: string) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        window.location.replace("/solutions/crossfit/dashboard/planos")
      } else {
        toast({
          title: "Erro ao sincronizar",
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const successUrl = `${baseUrl}/solutions/crossfit/dashboard/planos?success=true&session_id={CHECKOUT_SESSION_ID}`
      const cancelUrl = `${baseUrl}/solutions/crossfit/dashboard/planos?canceled=true`
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <div className="flex items-center gap-3 mb-6 px-1">
        <Link
          href="/solutions/crossfit/dashboard/configuracoes"
