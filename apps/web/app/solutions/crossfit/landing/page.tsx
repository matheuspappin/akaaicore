      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 font-bold text-2xl tracking-tight text-white hover:opacity-80 transition-opacity">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">
            Crossfit <span className="text-orange-400 font-black"></span>
          </span>
        </Link>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight text-white">
            Tudo na palma da mão do <span className="text-orange-400">Coach</span>
          </h2>
                ...
                {activeTab === 'chamada' && (
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col h-full">
                    <div className="bg-white p-4 rounded-2xl shadow-sm mb-4 flex items-center justify-between">
                      ...
                      <Badge className="bg-orange-100 text-orange-600 border-none">Turma Ballet</Badge>
                    </div>
...
function ManagementDashboard() {
  const stats = [
    { label: "Atletas Ativos", value: "124", icon: Users, color: "text-orange-500", trend: "+8 este mês" },
  ...
  const modules = [
    ...
    { label: "Coaches", icon: Heart, color: "bg-rose-600", shadow: "shadow-rose-500/30", description: "Agenda, pagamentos e avaliações de professores." },
    ...
    <section id="management" className="py-24 bg-slate-950/90 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-6 tracking-tight text-white">
            Controle total do seu <span className="text-orange-400">Box</span>
          </h2>
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
...
function FeatureGrid() {
  const features = [
    ...
    { title: "Multi-Tipo", description: "Ballet, jazz, funk, sapateado, contemporâneo e muito mais.", icon: Dumbbell, color: "from-amber-500 to-orange-400" },
  ]
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <Badge className="bg-orange-100 text-orange-600 border-none px-4 py-1.5 mb-6 uppercase tracking-[0.2em] text-[10px] font-black shadow-sm">
              Recursos
            </Badge>
  ...
  return (
    <section id="pricing" className="py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
        <Badge className="bg-orange-100 text-orange-600 border-none px-4 py-1.5 mb-6 uppercase tracking-[0.2em] text-[10px] font-black">
          Implementação
        </Badge>
        <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">
        ...
        <div className="bg-gradient-to-br from-orange-600 to-pink-600 rounded-3xl p-10 text-white shadow-2xl shadow-orange-500/20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-white text-orange-700 hover:bg-orange-50 font-bold h-14 px-8 rounded-2xl transition-all shadow-lg"
            >
              <Dumbbell className="w-5 h-5" />
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-400">seu estúdio?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12 pb-12 border-b border-white/5">
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href="/solutions/crossfit/login" className="text-slate-500 hover:text-orange-400 text-sm transition-colors flex items-center gap-2 group">
