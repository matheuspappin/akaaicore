  ...
  return (
    <div className="space-y-6 max-w-xl pb-20 md:pb-0">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1.5">
                  O código é fornecido pelo administrador do estúdio no painel Crossfit.
                </p>
              </div>
              <Button
      ...
      <div className="space-y-3">
        ...
        <Link href="/solutions/crossfit/student/perfil/privacidade">
        ...
        <Link href="/solutions/crossfit/student/perfil/preferencias">
          <Button variant="ghost" className="w-full justify-between bg-white dark:bg-slate-900/50 h-14 px-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 border border-slate-200 dark:border-white/10 rounded-xl">
            <div className="flex items-center gap-3">
        ...
        <Button
          ...
          onClick={async () => {
            ...
            window.location.href = "/solutions/crossfit/login"
          }}
        >
          <div className="flex items-center gap-3">
