    ...
    try {
      const res = await fetch('/api/dance-studio/packages/checkout', {
        ...
        body: JSON.stringify({
          ...
          successUrl: `${window.location.origin}/solutions/boxing/student/financeiro?payment=success&session_id={CHECKOUT_SESSION_ID}`,
          cancelUrl: `${window.location.origin}/solutions/boxing/student/financeiro?payment=cancelled`,
        }),
      })
