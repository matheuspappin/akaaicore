...
export default function TeacherPagamentosPage() {
  ...
  const handleStripeOnboarding = async () => {
    ...
    try {
      const returnUrl = `${window.location.origin}/solutions/martial_arts/teacher/pagamentos`
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-violet-200 dark:border-red-500/30">
        <CardHeader>
        ...
        <CardContent className="flex flex-wrap items-center gap-3">
          {stripeStatus?.stripe_account_id ? (
            ...
            <Button onClick={handleStripeOnboarding} disabled={stripeLinkLoading} className="bg-red-600 hover:bg-red-700">
