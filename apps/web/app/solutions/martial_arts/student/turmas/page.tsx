      ...
      {loading ? (
        ...
        <Card className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 overflow-hidden">
          ...
          <CardContent className="flex flex-col items-center justify-center py-20 text-center px-6">
            <div className="w-20 h-20 rounded-2xl bg-violet-100 dark:bg-red-900/30 flex items-center justify-center mb-4">
              <Music className="w-10 h-10 text-red-600 dark:text-red-400" />
            </div>
            ...
            <Link href="/solutions/martial_arts/student/turmas/catalogo">
        ...
        <>
                ...
                <CardContent className="p-5">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      {turma.dance_style && (
                        <p className="text-xs text-red-600 dark:text-red-400 font-bold mt-0.5">{turma.dance_style}</p>
                      )}
                    </div>
                    {turma.level && (
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full mt-4 h-10 rounded-xl font-bold text-sm border-violet-200 dark:border-red-700/50 text-red-600 dark:text-red-400 hover:bg-violet-50 dark:hover:bg-violet-950/30"
          ...
          <Link href="/solutions/martial_arts/student/turmas/catalogo">
            <Button
              variant="outline"
              className="w-full border-dashed border-2 border-violet-200 dark:border-red-700/40 text-red-600 dark:text-red-400 bg-violet-50/50 dark:bg-violet-950/20 hover:bg-violet-50 dark:hover:bg-violet-950/40 h-12 rounded-xl font-bold gap-2 transition-all"
            >
      ...
      <Dialog open={isQrOpen} onOpenChange={setIsQrOpen}>
        <DialogContent className="sm:max-w-md max-w-[90vw] rounded-2xl border-none">
          ...
          <div className="flex flex-col items-center justify-center py-6 gap-6">
            <div ref={qrContainerRef} className="bg-white p-4 rounded-3xl shadow-xl border-4 border-violet-50 dark:border-red-900/30">
              {activeAttendanceId ? (
