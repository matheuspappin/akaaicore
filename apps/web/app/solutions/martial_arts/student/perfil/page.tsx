  ...
  return (
    <div className="space-y-6 max-w-xl pb-20 md:pb-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1 flex-wrap">
            <span className="inline-block px-2 py-0.5 rounded-full bg-violet-100 dark:bg-red-600/20 text-red-700 dark:text-red-400 text-[10px] font-black uppercase tracking-widest">
              Aluno
            </span>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1.5">
                  O código é fornecido pelo administrador do estúdio no painel ArtesMarciais.
                </p>
              </div>
              <Button
      ...
      <div className="space-y-3">
        ...
        <Link href="/solutions/martial_arts/student/perfil/privacidade">
        ...
        <Link href="/solutions/martial_arts/student/perfil/preferencias">
          <Button variant="ghost" className="w-full justify-between bg-white dark:bg-slate-900/50 h-14 px-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 border border-slate-200 dark:border-white/10 rounded-xl">
            <div className="flex items-center gap-3">
        ...
        <Button
          ...
          onClick={async () => {
            ...
            window.location.href = "/solutions/martial_arts/login"
          }}
        >
          <div className="flex items-center gap-3">
