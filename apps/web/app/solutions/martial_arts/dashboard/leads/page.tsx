...
const stageMap: Record<string, { label: string; color: string }> = {
  ...
  contacted:       { label: "Contactado",  color: "bg-violet-100 text-red-700 dark:bg-red-600/20 dark:text-red-400" },
...
export default function LeadsPage() {
  ...
  const handleConvidarLead = (lead: any) => {
    ...
    const link = `${origin}/solutions/martial_arts/register?role=student&code=${inviteCode}`
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        copiedLinkId === lead.id
                          ...
                          : "text-red-600 border-violet-200 hover:bg-violet-50 dark:border-red-600/30 dark:text-red-400 dark:hover:bg-red-600/10"
                      )}
                    >
                      {copiedLinkId === lead.id
