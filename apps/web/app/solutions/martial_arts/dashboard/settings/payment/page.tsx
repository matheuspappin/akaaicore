// apps/web/app/solutions/martial_arts/dashboard/settings/payment/page.tsx
"use client"
      ...
      <div className="p-4 md:p-8 space-y-8 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <h2 className="text-lg font-black flex items-center gap-2"><CreditCard className="w-5 h-5 text-red-500" /> Métodos de Pagamento</h2>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center justify-between text-base">
                  <div className="flex items-center gap-2"><CreditCard className="w-4 h-4 text-red-500" /> Stripe (Pagamentos)</div>
                  <div className="flex items-center gap-1.5 text-xs">
          ...
          {/* Pacotes de Créditos */}
          <div className="space-y-6">
            <h2 className="text-lg font-black flex items-center gap-2"><Package className="w-5 h-5 text-red-500" /> Pacotes de Créditos</h2>
            
            <Card>
              <CardContent className="pt-6">
                {loadingCredits ? (
                  <div className="py-8 flex justify-center"><Loader2 className="w-5 h-5 animate-spin text-red-500" /></div>
                    ...
                    {creditPackages.map(pkg => (
                      <div key={pkg.id} className="flex items-center justify-between p-3 rounded-xl border bg-white dark:bg-white/5 transition-colors hover:border-violet-200">
                        ...
                        <div className="flex items-center gap-3">
                          <p className="font-black text-red-600 text-sm">R$ {Number(pkg.price).toFixed(2)}</p>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <Button className="w-full bg-red-600 hover:bg-red-700 h-10 mt-2 font-bold" onClick={addCreditPackage} disabled={!newPkg.lessons_count || !newPkg.price}>
