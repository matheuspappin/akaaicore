...
const CAL_COLORS = [
  ...
  { bg: "bg-violet-100 dark:bg-red-900/40", text: "text-red-800 dark:text-violet-200", border: "border-red-300 dark:border-red-700" },
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        // Carrega professores via API ArtesMarciais (professionals com professional_type = 'teacher')
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl shadow-lg shadow-red-600/20"
          >
      ...
      {loading ? (
        ...
        <Card className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10">
          <CardContent className="flex flex-col items-center justify-center py-20 text-center">
            ...
            {!activeStyle && (
              <Button onClick={() => setIsNewDialogOpen(true)} className="bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl">
            ...
            <Card key={turma.id} className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 hover:shadow-lg transition-all overflow-hidden">
              ...
              <CardContent className="p-5">
                <div className="flex items-start justify-between mb-3">
                  ...
                  {turma.level && (
                    <Badge className="bg-violet-100 text-red-700 dark:bg-red-600/20 dark:text-red-400 border-0 text-xs font-bold">
                      {turma.level}
                    </Badge>
                  )}
                </div>
                ...
                <div className="mt-4 flex gap-2">
                  <Link href={`/solutions/martial_arts/dashboard/turmas/${turma.id}/chamada`}>
                    <Button size="sm" variant="outline" className="flex-1 rounded-xl text-xs font-bold border-violet-200 text-red-600 hover:bg-violet-50">
                      Fazer Chamada
                    </Button>
                  </Link>
                  <Button
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button type="button" size="sm" variant="outline" onClick={addScheduleItem} className="h-7 text-xs font-bold rounded-lg border-violet-200 text-red-600 hover:bg-violet-50">
                ...
                <>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button type="button" size="sm" variant="outline" onClick={addEditScheduleItem} className="h-7 text-xs font-bold rounded-lg border-violet-200 text-red-600 hover:bg-violet-50">
