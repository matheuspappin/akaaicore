...
const navItems = [
  { href: "/solutions/daycare/architect", label: "Dashboard", icon: LayoutDashboard },
  { href: "/solutions/daycare/architect/projetos", label: "Meus Projetos", icon: FolderKanban },
  { href: "/solutions/daycare/architect/perfil", label: "Meu Perfil", icon: UserCircle },
]
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-slate-950 border-b border-white/10 flex items-center justify-between px-4 z-40">
        <div className="flex items-center gap-2">
          ...
          <span className="font-black text-white text-sm">CrecheInfantil <span className="text-violet-400">Arq</span></span>
        </div>
