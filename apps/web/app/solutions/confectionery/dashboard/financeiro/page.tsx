...
const statusMap = {
  ...
  vencido: { label: "Vencido", className: "bg-red-100 text-pink-700 dark:bg-pink-600/20 dark:text-pink-400" },
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          },
          {
            ...
            color: saldo >= 0 ? "text-blue-600" : "text-pink-600",
            bg: saldo >= 0 ? "bg-blue-600/10" : "bg-pink-600/10",
            border: saldo >= 0 ? "border-l-blue-600" : "border-l-pink-600",
          },
          {
            label: "A Receber",
            ...
            {filtered.map((l, i) => {
              ...
              return (
                <tr key={l.id} className={cn("border-b border-slate-50 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors", i === filtered.length - 1 && "border-0")}>
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <div className={cn(
                        ...
                        l.tipo === "receita" ? "bg-emerald-500" : "bg-pink-500"
                      )} />
                  ...
                  <td className="px-4 py-3">
                    <span className={cn("font-black text-sm", l.tipo === "receita" ? "text-emerald-600" : "text-pink-600")}>
