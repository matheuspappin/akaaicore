    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" onClick={() => router.back()} asChild>
          <Link href="/solutions/podiatry/technician/os">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button asChild>
              <Link href="/solutions/podiatry/technician/scanner">
                Abrir Scanner
              </Link>
            </Button>
            <Button variant="outline" asChild>
              <Link href="/solutions/podiatry/technician/os">Voltar para OS</Link>
            </Button>
          </div>
        </div>
      )}
