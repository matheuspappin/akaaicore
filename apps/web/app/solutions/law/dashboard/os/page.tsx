    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Button className="flex-1 bg-slate-600 hover:bg-slate-700 text-white font-bold" onClick={handleSubmit} disabled={loading || !form.title}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        {created.length === 0 ? (
          <div className="grid gap-4 py-2">
            ...
            <Button className="w-full bg-slate-600 hover:bg-slate-700" onClick={handleGerar} disabled={loading}>
          ...
          <div className="space-y-4">
            ...
            <Button className="w-full bg-slate-600 hover:bg-slate-700" onClick={handlePrint} disabled={printing}>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        {os.priority === "urgente" && (
                          <Badge className="text-xs font-bold border-0 bg-red-100 text-slate-700 dark:bg-slate-600/20 dark:text-slate-400">
