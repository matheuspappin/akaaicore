...
function RegisterContent() {
    ...
    try {
      ...
      if (response.ok && data.success) {
        toast({
          ...
          description: "Bem-vindo ao Tattoo&Piercing! Seu teste grátis começou.",
        })
        ...
        if (role === 'student') router.push("/solutions/tattoo/client")
        else if (role === 'teacher') router.push("/solutions/tattoo/technician")
        else if (role === 'engineer') router.push("/solutions/tattoo/engineer")
        else if (role === 'finance') router.push("/solutions/tattoo/dashboard")
        else router.push("/solutions/tattoo/dashboard")
      } else {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex relative font-sans">
      ...
      <Link href="/solutions/tattoo" className="absolute top-6 left-6 z-50 flex items-center gap-2 text-white/60 hover:text-white transition-colors text-sm font-bold uppercase tracking-widest">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-zinc-700 via-zinc-600 to-orange-600 p-12 flex-col justify-between relative overflow-hidden">
        ...
        >
          <Link href="/solutions/tattoo" className="flex items-center gap-3 group">
            <motion.div 
        ...
        >
           ...
           <div className="relative">
             ...
             <p className="text-sm text-white/80 leading-relaxed font-medium pl-2">
               O <span className="text-white font-bold">Tattoo&Piercing</span> reduziu nosso tempo de vistoria em 40% e eliminou completamente os erros humanos na gestão de validade de carga.
             </p>
           </div>
            ...
            <CardContent className="px-0 pt-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  {role === 'admin' && (
                    <div className="space-y-2 col-span-full">
                      ...
                      <Input
                        placeholder="Ex: Tattoo&Piercing Soluções"
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-slate-400 font-medium">
                  Já tem uma conta?{" "}
                  <Link href="/solutions/tattoo/login" className="text-zinc-500 hover:text-zinc-400 font-bold underline underline-offset-4">
                    Acesse o Login
                  </Link>
                </p>
              </div>
