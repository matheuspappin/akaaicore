...
const statusMap = {
  ...
  vencido: { label: "Vencido", icon: XCircle, className: "bg-red-100 text-indigo-700 dark:bg-indigo-600/20 dark:text-indigo-400" },
}
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-600/20" disabled={!studioId}>
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <FireExtinguisher className="w-5 h-5 text-indigo-600" />
            Cadastrar Extintor
          </DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="grid gap-4 py-2">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Button type="submit" className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white font-bold" disabled={loading}>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-sm">
        ...
        <div className="flex flex-col items-center gap-4 py-4">
          ...
          <Button onClick={handlePrint} className="w-full bg-indigo-600 hover:bg-indigo-700" size="lg">
        ...
        <div className="flex gap-2">
          {(["todos", "ok", "vencendo", "vencido"] as const).map((f) => (
            <Button
              ...
              size="sm"
              className={cn(filtro === f && "bg-indigo-600 hover:bg-indigo-700 border-indigo-600")}
              onClick={() => setFiltro(f)}
            >
                ...
                return (
                  <tr key={ext.id} className={cn("border-b border-slate-50 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors", i === filtered.length - 1 && "border-0")}>
                    <td className="px-4 py-3">
                      <span className="text-xs font-black text-indigo-600 bg-red-50 dark:bg-indigo-600/10 px-2 py-0.5 rounded-lg">{displayId(ext)}</span>
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem className="text-indigo-600"><Trash2 className="w-4 h-4 mr-2" />Remover</DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </td>
                  </tr>
