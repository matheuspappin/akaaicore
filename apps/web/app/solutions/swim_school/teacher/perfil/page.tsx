        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1 flex-wrap">
            ...
            {vinculo.linked && vinculo.studio && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-violet-100 dark:bg-blue-600/20 text-blue-700 dark:text-blue-400 text-[10px] font-black uppercase tracking-widest">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1.5">
                  O código é fornecido pelo administrador do estúdio no painel Natação.
                </p>
              </div>
              <Button
