;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="90e6d9da-8074-e780-c8f7-1b36b6376a7b")}catch(e){}}();
module.exports = [
...
"[project]/apps/web/app/api/dance-studio/teacher-payments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (mine) {
        const { data: prof } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('professionals').select('id').eq('user_id', access.userId).eq('studio_id', studioId).maybeSingle();
        if (prof) professionalId = prof.id;
    }
    let q = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('teacher_payment_entries').select('*, professionals(id, name, email)').eq('studio_id', studioId).order('scheduled_date', {
        ascending: false
    });
    ...
    const withdrawn = (data || []).filter((e)=>e.status === 'withdrawn').reduce((s, e)=>s + Number(e.amount), 0);
...
//# debugId=90e6d9da-8074-e780-c8f7-1b36b6376a7b
//# sourceMappingURL=%5Broot-of-the-server%5D__3f0fbb14._.js.map