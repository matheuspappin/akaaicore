;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="92d698a3-e1c2-2525-33cb-ab1fc14f8725")}catch(e){}}();
module.exports = [
...
"[project]/apps/web/app/api/dance-studio/usage/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const [studentsRes, teachersRes, studioRes] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('students').select('*', {
                count: 'exact',
                head: true
            }).eq('studio_id', studioId),
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('teachers').select('*', {
                count: 'exact',
                head: true
            }).eq('studio_id', studioId).eq('status', 'active'),
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('studios').select('plan, verticalization_plan_id').eq('id', studioId).maybeSingle()
        ]);
        const plan = studioRes.data?.plan || 'gratuito';
        let planName = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$plan$2d$limits$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLAN_LIMITS"].gratuito.name;
        if (studioRes.data?.verticalization_plan_id) {
            const { data: vp } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('verticalization_plans').select('name').eq('id', studioRes.data.verticalization_plan_id).maybeSingle();
            planName = vp?.name ?? planName;
        } else if (studioRes.data?.plan) {
            const normId = [
                'starter',
                'free'
            ].includes(studioRes.data.plan.toLowerCase()) ? 'gratuito' : studioRes.data.plan === 'pro+' ? 'pro-plus' : studioRes.data.plan;
            planName = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$plan$2d$limits$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLAN_LIMITS"][normId]?.name ?? null;
            if (!planName) {
                const { data: sp } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('system_plans').select('name').eq('id', studioRes.data.plan).maybeSingle();
...
//# debugId=92d698a3-e1c2-2525-33cb-ab1fc14f8725
//# sourceMappingURL=%5Broot-of-the-server%5D__f78afcbb._.js.map