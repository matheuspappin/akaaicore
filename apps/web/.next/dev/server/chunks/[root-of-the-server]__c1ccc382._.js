;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="5a6542be-e10b-43de-6cd8-cae8136322bc")}catch(e){}}();
module.exports = [
...
"[project]/apps/web/app/api/dashboard/live-classes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (!supabaseServiceKey) {
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('❌ [LIVE-CLASSES] SUPABASE_SERVICE_ROLE_KEY não configurada.');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Configuração de segurança (Service Key) ausente no servidor.'
        }, {
            status: 500
        });
    }
    ...
    try {
        ...
        if (!studioId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'ID do estúdio não fornecido.'
            }, {
                status: 400
            });
        }
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info(`🔍 [LIVE-CLASSES] Buscando para Studio: ${studioId}, Dia: ${dayOfWeek}, Hora: ${currentTime}`);
        // 2. Buscar turmas ativas
        const { data: classes, error: classesError } = await supabase.from('classes').select('*, professionals(name)').eq('studio_id', studioId).eq('status', 'active');
        if (classesError) {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('❌ [LIVE-CLASSES] Erro ao buscar turmas:', classesError);
            throw classesError;
        }
        ...
        const liveClasses = (classes || []).filter((cls)=>{
            ...
            return schedule.some((s)=>{
                ...
                if (!startTime.includes(':')) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].warn(`⚠️ [LIVE-CLASSES] Formato de horário inválido para turma ${cls.name}: start=${startTime}`);
                    return false;
                }
        ...
        const results = await Promise.all(liveClasses.map(async (cls)=>{
            ...
            const currentSchedule = cls.schedule.find((s)=>s.day_of_week === dayOfWeek);
            ...
            // Buscar matrículas
            const { data: enrollments, error: enrollError } = await supabase.from('enrollments').select('student_id, students(name, phone)').eq('class_id', cls.id).eq('status', 'active');
            if (enrollError) __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].warn(`⚠️ [LIVE-CLASSES] Erro enrollments para turma ${cls.name} (${cls.id}):`, enrollError);
            // Buscar presenças
            const { data: attendance, error: attError } = await supabase.from('attendance').select('*').eq('class_id', cls.id).eq('date', todayStr);
            if (attError) __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].warn(`⚠️ [LIVE-CLASSES] Erro attendance para turma ${cls.name} (${cls.id}):`, attError);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('💥 [LIVE-CLASSES] Erro fatal:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# debugId=5a6542be-e10b-43de-6cd8-cae8136322bc
//# sourceMappingURL=%5Broot-of-the-server%5D__c1ccc382._.js.map