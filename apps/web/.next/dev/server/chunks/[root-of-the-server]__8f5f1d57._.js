;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="32d4f07b-6cb7-b1a0-e29f-f85a74730d2f")}catch(e){}}();
module.exports = [
...
"[project]/apps/web/app/api/dance-studio/teacher-payments/balance/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const { data: entries, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('teacher_payment_entries').select('amount, status').eq('professional_id', prof.id);
    ...
    const released = (entries || []).filter((e)=>e.status === 'released').reduce((s, e)=>s + Number(e.amount), 0);
    const withdrawn = (entries || []).filter((e)=>e.status === 'withdrawn').reduce((s, e)=>s + Number(e.amount), 0);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# debugId=32d4f07b-6cb7-b1a0-e29f-f85a74730d2f
//# sourceMappingURL=%5Broot-of-the-server%5D__8f5f1d57._.js.map