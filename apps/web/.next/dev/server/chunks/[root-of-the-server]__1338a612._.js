;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="17b69d79-ba97-ae16-4ad3-be58e3447e10")}catch(e){}}();
module.exports = [
...
async function getAdminClient() {
    ...
    try {
        const adminClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(("TURBOPACK compile-time value", "https://drgibkczwshwjjsdauoj.supabase.co"), serviceKey, {
            auth: {
                persistSession: false,
                autoRefreshToken: false,
                detectSessionInUrl: false
...
;
;
const getServerOrganizationConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cache"])(async ()=>{
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getTenantsList, "7023d6cad867de4ac7c7728323b015287a615627ae", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteTenant, "60d757fa814f4ba3d71e330842b1bbafe042780e30", null);
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteStudio, "60d86907e45661f0b46a0babd46a8fa791f6191306", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(deletePartner, "60b86a7e7a20cbe3d22815ec80f1d53f3854561426", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getPartnersList, "70acc0770a04eafbcb2b8dfdc21d578107972639bc", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(updatePartner, "7054215b14b279c12cae05862327ec04d5f004761c", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(saveSystemPlan, "60963e2fbcb190efcc176cdce5be440699b7b539a0", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteSystemPlan, "60f10e23c67b0bc35b4e0932d8395bbba63cbf1f79", null);
}),
"[project]/apps/web/app/api/admin/confirm-scan/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    if (!supabaseServiceKey) {
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('CRÍTICO: SUPABASE_SERVICE_ROLE_KEY não configurada no servidor.');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Erro de configuração no servidor (Chave de API).'
        }, {
            status: 500
        });
    }
    ...
    try {
        ...
        if (!attendanceId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Código de presença ausente'
            }, {
                status: 400
            });
        }
        ...
        const { data: asset, error: assetError } = await supabaseAdmin.from('assets').select('*, student:students(name)').eq('qr_code', attendanceId).maybeSingle();
        if (asset) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ...
                className: `${asset.name} (${asset.type || 'N/A'})`,
                message: message,
        ...
        if (attendanceId.toString().startsWith('DF-')) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('🔍 [BACKEND] Buscando UUID para código curto:', shortCode);
            // Busca robusta: Filtramos registros do dia para encontrar o UUID correspondente
            const todayStr = new Date().toISOString().split('T')[0];
            const { data: records, error: searchError } = await supabaseAdmin.from('attendance').select('id').eq('date', todayStr);
            if (searchError) {
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('❌ [BACKEND] Erro ao buscar registros do dia:', searchError);
            }
            const match = records?.find((r)=>r.id.toUpperCase().endsWith(shortCode));
            if (!match) {
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].warn('⚠️ [BACKEND] Código não encontrado nos registros de hoje. Tentando busca global...');
                ...
                const { data: allRecords } = await supabaseAdmin.from('attendance').select('id').limit(100); // Limitamos para evitar sobrecarga, assumindo que códigos recentes estarão aqui
                const globalMatch = allRecords?.find((r)=>r.id.toUpperCase().endsWith(shortCode));
                if (!globalMatch) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('❌ [BACKEND] Código de acesso não localizado:', shortCode);
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        success: false,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info('✅ [BACKEND] UUID Localizado:', targetId);
        }
        // 1. Buscar a presença e dados do aluno/turma
        const { data: attendance, error: attError } = await supabaseAdmin.from('attendance').select('*, student:students(id, name), class:classes(id, name, studio_id)').eq('id', targetId).single();
        ...
        if (attendance.status === 'present') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Esta presença já foi validada anteriormente.'
            }, {
                status: 400
            });
        }
        // 2. Validar créditos do aluno
        const { data: credits, error: creditError } = await supabaseAdmin.from('student_lesson_credits').select('*').eq('student_id', attendance.student_id).maybeSingle();
        ...
        if (result.new_balance <= 2) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$whatsapp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyLowCredits"])(attendance.student_id, attendance.class.studio_id, result.new_balance).catch((e)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('Erro ao enviar notificação de crédito baixo:', e);
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('Erro ao validar scan admin:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: error.message
        }, {
...
//# debugId=17b69d79-ba97-ae16-4ad3-be58e3447e10
//# sourceMappingURL=%5Broot-of-the-server%5D__1338a612._.js.map