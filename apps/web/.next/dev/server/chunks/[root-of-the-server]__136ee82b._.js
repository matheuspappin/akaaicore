;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="53c3a584-40e8-5aa0-4fd4-f48eba36f84f")}catch(e){}}();
module.exports = [
...
"[project]/apps/web/lib/constants/stripe-connect.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/api/dance-studio/packages/checkout/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$constants$2f$stripe$2d$connect$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/constants/stripe-connect.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/logger.ts [app-route] (ecmascript)");
...
async function POST(request) {
    ...
    try {
        ...
        const { data: pkg, error: pkgError } = await supabase.from('lesson_packages').select('id, name, description, lessons_count, price, is_active, studio_id, billing_type').eq('id', packageId).eq('studio_id', studioId).eq('is_active', true).single();
        if (pkgError || !pkg) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { data: student, error: studentError } = await supabase.from('students').select('id, name, email').eq('id', studentId).maybeSingle();
        ...
        const stripeAccountId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$actions$2f$studio$2d$stripe$2d$connect$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStudioStripeAccountForCheckout"])(studioId);
        ...
        if (billingType === 'monthly') {
            ...
            const subscriptionData = stripeAccountId ? {
                metadata: sessionMetadata,
                transfer_data: {
                    destination: stripeAccountId
                },
                application_fee_percent: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$constants$2f$stripe$2d$connect$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLATFORM_FEE_PERCENT"]
            } : {
                metadata: sessionMetadata
            };
                ...
                line_items: [
                    {
                        price_data: {
                            ...
                            product_data: {
                                name: pkg.name,
                                description: pkg.description || `${pkg.lessons_count} crédito(s) por ciclo (mensal)`,
                                metadata: {
                                    studio_id: studioId,
                                    package_id: pkg.id
                                }
            ...
            const connectParams = stripeAccountId ? {
                payment_intent_data: {
                    application_fee_amount: Math.round(priceInCents * (__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$constants$2f$stripe$2d$connect$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLATFORM_FEE_PERCENT"] / 100)),
                    transfer_data: {
                        destination: stripeAccountId
                    }
                }
            ...
            session = await stripe.checkout.sessions.create({
                payment_method_types: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$stripe$2d$checkout$2d$methods$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStripeCheckoutPaymentMethodTypes"])(),
                mode: 'payment',
                customer_email: studentEmail,
                line_items: [
                    {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].info(`✅ [PACKAGES/CHECKOUT] Sessão Stripe criada para aluno ${studentId}, pacote ${pkg.name}`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            url: session.url,
            sessionId: session.id
        });
    } catch (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].error('❌ [PACKAGES/CHECKOUT] Erro:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error.message
        }, {
            status: 500
...
//# debugId=53c3a584-40e8-5aa0-4fd4-f48eba36f84f
//# sourceMappingURL=%5Broot-of-the-server%5D__136ee82b._.js.map