;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="f7dc347d-7870-e29b-2782-59527ad37d43")}catch(e){}}();
module.exports = [
...
"[project]/apps/web/app/api/dance-studio/studio/invite-code/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function resolveStudioId(userId, studioIdMeta) {
    if (studioIdMeta) return studioIdMeta;
    // fallback: busca por owner_id
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('studios').select('id').eq('owner_id', userId).maybeSingle();
    return data?.id ?? null;
}
async function GET(request) {
    try {
        ...
        const themeConfig = orgSettings?.theme_config || {};
        const inviteCodes = themeConfig.invite_codes || {};
        ...
        if (changed) {
            ...
            const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('organization_settings').update({
...
async function POST(request) {
    try {
        ...
        const type = body.type === 'student' ? 'student' : 'teacher';
        const studioId = await resolveStudioId(user.id, user.user_metadata?.studio_id);
...
//# debugId=f7dc347d-7870-e29b-2782-59527ad37d43
//# sourceMappingURL=%5Broot-of-the-server%5D__4a223b0f._.js.map